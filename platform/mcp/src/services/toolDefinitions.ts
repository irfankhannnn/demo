 ...
 * (`agency-app/api/shared/toolDefinitions.js`) into `./generatedToolDefinitions.ts` by
 * `agency-app/api/scripts/generate-mcp-tools.mjs`, which runs on `prebuild`. This file
