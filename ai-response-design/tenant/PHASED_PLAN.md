...
### Deliverables
- `server/normalizers/tenantNormalizer.js`
- Unit tests in `server/normalizers/tenantNormalizer.test.js`
...
### Deliverables
- `server/aiViewBuilders/tenantAIViewBuilder.js`
- Unit tests in `server/aiViewBuilders/tenantAIViewBuilder.test.js`
...
### Changes to `server/agents/responseFormatter.js`
...
### Changes to `server/agents/sanitizeAgentReply`
