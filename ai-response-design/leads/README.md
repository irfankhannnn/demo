...
|-------|----------|--------|
| Normalizer | `server/normalizers/leadNormalizer.js` | Implemented |
| View builder | `server/aiViewBuilders/leadAIViewBuilder.js` | Implemented |
| Middleware | `server/aiDtoMiddleware.js` | Flag `USE_AI_DTO_FOR_LEADS` |
| Mini-profile card | `server/agents/formatting/entityCards.js` | Implemented |
