...
- `ai-response-design/property/PROPERTY_AI_DTO_CONTRACT.md`
- `ai-response-design/property/PROPERTY_AI_VIEW_BUILDER.md` (create if missing)
- `ai-response-design/property/COMPLETE_PROPERTY_MANAGEMENT.md` (reference)
...
- `server/normalizers/propertyNormalizer.js`
- `server/normalizers/propertyNormalizer.test.js`
...
- `server/aiViewBuilders/propertyAIViewBuilder.js`
- `server/aiViewBuilders/propertyAIViewBuilder.test.js`
...
- `server/services/propertyService.test.js`
...
**Goal:** Update `server/aiDtoMiddleware.js` to route property tool results through the new pipeline.

### Files

- `server/aiDtoMiddleware.js`
- `server/aiDtoMiddleware.test.js`
...
1. Update `server/agents/prompts.js`:
...
3. Update `server/agents/responseFormatter.js`:
...
- `server/aiImplementation.test.js`
- `server/aiDtoMiddleware.test.js`
- `server/aiViewBuilders/propertyAIViewBuilder.test.js`
- `server/normalizers/propertyNormalizer.test.js`
- `server/services/propertyService.test.js`
...
1. In `server/aiImplementation.test.js` (or `server/aiImplementation.test.js` if new), add end-to-end test cases:
...
2. In `server/aiDtoMiddleware.test.js`:
...
- `.env.example`
- `server/config.js` (if feature flags are centralized)
- `server/aiDtoMiddleware.js`
- `server/agents/prompts.js`
- `server/agents/responseFormatter.js`
