...
**File:** `server/observability/cloudwatch.js`
...
**File:** `server/infra/cloudwatch-dashboard.json` (new file)
...
**File:** `server/infra/sns-topic.yaml` (new file)
