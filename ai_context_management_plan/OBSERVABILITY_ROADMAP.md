...
```typescript
// server/services/diagnostics/events.ts
...
```typescript
// server/services/diagnostics/tool-loop-detector.ts
...
```typescript
// server/services/diagnostics/session-usage.ts
...
```typescript
// server/services/diagnostics/cache-trace.ts
...
```typescript
// server/services/security/audit.ts
...
**Files:**
- `server/services/diagnostics/events.ts` (new)
- `server/services/diagnostics/event-types.ts` (new)
- `server/services/diagnostics/event-emitter.ts` (new)
...
**Files:**
- `server/services/diagnostics/otel.ts` (new)
- `server/services/diagnostics/otel-exporter.ts` (new)
...
**Files:**
- `server/agents/agentRuntime.js` (update)
- `server/services/diagnostics/tool-loop-detector.ts` (new)
...
- `server/services/diagnostics/cache-trace.ts` (new)
...
**Files:**
- `server/services/diagnostics/session-usage.ts` (new)
- `server/services/diagnostics/usage-aggregator.ts` (new)
...
**Files:**
- `server/services/security/audit.ts` (new)
- `server/services/security/audit-checks.ts` (new)
...
**Files:**
- `server/services/security/audit-logger.ts` (new)
...
```typescript
// server/services/diagnostics/cloudwatch-exporter.ts
