...
**Files:** `server/routes/auth.js`, `server/bailey.js`
...
**File:** `real-estate-crm-app/src/pages/onboarding/ConnectWhatsApp.tsx`
...
**File:** `real-estate-crm-app/src/pages/crm/CRMDashboard.tsx`
...
**File:** `server/whatsappConversationService.js` (NEW)
...
**File:** `server/routes/whatsappConversations.js` (NEW)
...
**File:** `real-estate-crm-app/src/pages/crm/WhatsAppInbox.tsx` (NEW)
...
**File:** `real-estate-crm-app/src/App.tsx`
...
**File:** `real-estate-crm-app/src/pages/crm/AiEmployee.tsx`
...
**File:** `real-estate-crm-app/src/components/ContactActivityTimeline.tsx`
...
**File:** `real-estate-crm-app/src/components/LeadDrawer.tsx` (or equivalent)
...
**File:** `real-estate-crm-app/src/pages/crm/LeadsList.tsx` (or equivalent)
...
**File:** `server/crmDynamodbService.js`
...
**File:** `real-estate-crm-app/src/components/CreditBalanceCard.tsx`
...
**File:** `real-estate-crm-app/src/components/AgentActivityLog.tsx`
...
**File:** `real-estate-crm-app/src/pages/crm/BillingSettings.tsx`
...
- `server/routes/whatsappConversations.js`
- `real-estate-crm-app/src/pages/crm/WhatsAppInbox.tsx`
- `real-estate-crm-app/src/components/WhatsAppChatThread.tsx`
- `real-estate-crm-app/src/components/WhatsAppConversationList.tsx`
- `real-estate-crm-app/src/components/LeadAssignmentDropdown.tsx`
- `real-estate-crm-app/src/components/AiEmployeeDashboard.tsx`
- `real-estate-crm-app/src/types/whatsapp.ts`

### Modified Files (12)
- `server/routes/auth.js` — Add status/disconnect/sessions endpoints
- `server/routes/webhooks.js` — Fix auth logic, remove hardcoded values
- `server/scripts/whatsapp-message-processor.js` — Enable audit, add AI prefix
- `server/routes/leads.js` — Fix `/agents` endpoint
- `server/agents/prompts.js` — Improve conciseness, add few-shot examples
- `server/bailey.js` — Fix signature verification
- `baileys-service/src/baileysClient.js` — Stability fixes
- `real-estate-crm-app/src/pages/onboarding/ConnectWhatsApp.tsx` — Fix QR logic
- `real-estate-crm-app/src/pages/crm/CRMDashboard.tsx` — Add nav + status
- `real-estate-crm-app/src/pages/crm/AiEmployee.tsx` — Redesign with 3 tabs
- `real-estate-crm-app/src/services/api.ts` — Add conversation APIs
- `real-estate-crm-app/src/App.tsx` — Add routes
