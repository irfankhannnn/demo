...
**Location:** `server/routes/billing.js:331-356`  
**Severity:** CRITICAL  
...
**Location:** `server/subscriptionService.js:121`, `server/routes/billing.js`  
**Severity:** CRITICAL  
...
**Location:** `server/routes/billing.js:306-328`  
**Severity:** CRITICAL  
...
**Location:** `server/routes/billing.js:363-368`  
**Severity:** CRITICAL  
...
**Location:** `server/scripts/credit-reset-cron.js:85-101`  
**Severity:** CRITICAL  
...
**Location:** `server/creditService.js:43-48`  
**Severity:** CRITICAL  
...
**Location:** `server/infra/cfn-backend.yaml`, `server/infra/launch-tables-cfn.yaml`  
**Severity:** CRITICAL  
...
**Location:** `server/agencyConfigService.js:42`  
**Severity:** CRITICAL  
...
**Location:** `server/routes/leads.js:311-316`  
**Severity:** CRITICAL  
...
**Location:** `server/bailey.js:239-240`  
**Severity:** CRITICAL  
...
**Location:** `server/routes/billing.js`  
**Severity:** HIGH  
...
**Location:** `server/routes/billing.js:139-144`  
**Severity:** HIGH  
...
**Location:** `server/routes/billing.js:131-361`  
**Severity:** HIGH  
...
**Location:** `server/routes/subscriptions.js:154-169`  
**Severity:** HIGH  
...
**Location:** `server/routes/creditAdmin.js:24-42`  
**Severity:** HIGH  
...
**Location:** `server/routes/billing.js:203`  
**Severity:** HIGH  
...
**Location:** `server/infra/cfn-backend.yaml`  
**Severity:** HIGH  
...
**Location:** `server/routes/subscriptions.js`, `server/routes/billing.js`  
**Severity:** MEDIUM  
...
**Location:** `server/subscriptionService.js`  
**Severity:** MEDIUM  
...
**Location:** `server/subscriptionService.js:68-97`  
**Severity:** MEDIUM  
...
**Location:** `server/creditConfig.js:91-105`  
**Severity:** MEDIUM  
...
**Location:** `server/routes/billing.js:294-303`  
**Severity:** MEDIUM  
...
**Location:** `server/scripts/trial-reminder-cron.js:29-46`  
**Severity:** MEDIUM  
...
**Location:** `server/routes/billing.js:334-355`  
**Severity:** LOW  
...
|------|--------|----------|
| `server/routes/billing.js` | #1, #2, #3, #4, #11, #12, #13, #18, #32, #41, #42 | 🔴🟠🟡🟢 |
| `server/subscriptionService.js` | #2, #26, #27 | 🔴🟡 |
| `server/creditService.js` | #5, #6 | 🔴 |
| `server/routes/subscriptions.js` | #14 | 🟠 |
| `server/routes/creditAdmin.js` | #15 | 🟠 |
| `server/middleware/rateLimiter.js` | #16, #17, #29, #33 | 🟠🟡 |
| `server/infra/cfn-backend.yaml` | #7, #8, #19, #20 | 🔴🟠 |
| `server/routes/leads.js` | #9 | 🔴 |
| `server/bailey.js` | #10 | 🔴 |
| `server/creditConfig.js` | #28 | 🟡 |
| `server/logger.js` | #34 | 🟡 |
| `server/routes/auth.js` | #37 | 🟡 |
| `server/scripts/credit-reset-cron.js` | #5 | 🔴 |
| `server/scripts/trial-reminder-cron.js` | #40 | 🟡 |
