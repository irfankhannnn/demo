...
**File:** `real-estate-crm-app/vitest.config.ts`
...
**File:** `real-estate-crm-app/src/__tests__/setup.ts`
...
**File:** `real-estate-crm-app/src/__tests__/unit/components/LeadCard.test.tsx`
...
**File:** `real-estate-crm-app/src/__tests__/unit/hooks/useBuyers.test.ts`
