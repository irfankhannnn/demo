...
# property-pages-ms/infra/deploy.sh. This wrapper's only job is release
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../property-pages-ms" && pwd)"
...
# helper as property-pages-ms/infra/deploy.sh, reused here for rollback-full,
