...
# landing-pages/infra/deploy.sh. This wrapper's only job is release
# bookkeeping — see README.md in this folder for the full design, and
# cfn-templates-cicd/real-estate-crm-app/README.md for the reference design
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../landing-pages" && pwd)"
