...
**Full list:** See `server/shared/toolDefinitions.js`
...
- `MCP_REMAINING_PLAN.md` — Remaining phases (4-9)
- `server/mcp-server/httpServer.js` — Main server code
- `server/mcp-server/resources.js` — Resource handlers
- `server/mcp-server/prompts.js` — Prompt generators
