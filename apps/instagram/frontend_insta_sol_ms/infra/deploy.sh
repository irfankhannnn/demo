...
# apps/crm/real-estate-crm-app/infra/deploy.sh: a pure CFN parameter change
...
if [ ! -f "$ENV_FILE" ]; then
  ...
  echo "Copy apps/instagram/frontend_insta_sol_ms/.env.sample to $ENV_FILE and fill in the values."
  exit 1
fi
