        ...
        */}
        ...
        <div className="glass-premium rounded-2xl p-5 sm:p-6 mt-6 sm:mt-8 shadow-lg shadow-black/5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
            ...
            {isAdmin && (
              <button
                onClick={() => navigate('/crm/call-recordings')}
              ...
              >
                <span className="flex items-center gap-2">
                  <PhoneCall className="w-4 h-4 text-blue-600 group-hover:text-blue-700 transition-colors" />
                  Call Recordings
                </span>
            ...
            {isAdmin && (
              <button
                onClick={() => navigate('/crm/agency-policies')}
                className="flex items-center justify-between px-3 py-2.5 text-sm text-slate-600 hover:bg-white/50 rounded-xl transition-all duration-200 group border border-slate-200/70 hover:border-indigo-400/70 bg-white/50 font-semibold"
              >
                <span className="flex items-center gap-2">
                  <BookText className="w-4 h-4 text-indigo-600 group-hover:text-indigo-700 transition-colors" />
                  Agency Policies
                </span>
            ...
            <button
              onClick={() => navigate('/crm/marketplace/inbox')}
              className="flex items-center justify-between px-3 py-2.5 text-sm text-slate-600 hover:bg-white/50 rounded-xl transition-all duration-200 group border border-slate-200/70 hover:border-orange-400/70 bg-white/50 font-semibold"
            >
              <span className="flex items-center gap-2">
                <Store className="w-4 h-4 text-orange-600 group-hover:text-orange-700 transition-colors" />
                Marketplace Inbox
              </span>
