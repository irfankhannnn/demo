 ...
 * `docs/services/server/DISABLED_FEATURES.md`. Every shape here is what the CRM server
...
/** Mirrors CALL_STATUS in services/ai-calling-service/src/config/constants.js. */
