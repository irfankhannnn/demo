...
naming convention as the backend services (`apps/crm/server/`,
`services/reality-flow-authentication/`) — see `infra/cicd/reality-flow-authentication`
...
`infra/cicd/real-estate-crm-app/deploy.sh <dev|prod>` — it delegates
