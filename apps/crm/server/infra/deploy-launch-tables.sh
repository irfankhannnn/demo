...
#   Deploys apps/crm/server/infra/launch-tables-cfn.yaml — the DynamoDB tables shared
...
#
#   This is a separate script (not apps/crm/server/infra/deploy.sh) and a separate
...
# wrapper (infra/cicd/launch-tables/deploy.sh) reads this back to
