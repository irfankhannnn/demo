 ...
 *
 * Usage:
 *   node apps/crm/server/scripts/repair-lead-conversion-data.js [--apply] [--tenant TENANT_ID]
 *
 * Without --apply, only writes a JSON report to apps/crm/server/scripts/reports/.
 */
