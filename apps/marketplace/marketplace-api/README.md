...
[`docs/services/marketplace-api/API-CONTRACT.md`](../../../docs/services/marketplace-api/API-CONTRACT.md).
...
[`apps/crm/server/marketplaceIndexing.js`](../../crm/server/marketplaceIndexing.js);
...
infra/cicd/marketplace-api/deploy.sh dev
