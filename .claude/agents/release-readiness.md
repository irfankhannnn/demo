...
1. Save full report: `<output_dir>/release-readiness.md`
   Use template: `engineering-change-intelligence/templates/release-readiness-report.md`

2. Save Slack-formatted summary: `<output_dir>/slack-message.md`
   Use template: `engineering-change-intelligence/templates/slack-message.md`
