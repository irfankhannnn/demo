 ...
 *
 * `reality-flow-mcp/src/services/toolDefinitions.ts` used to be a hand-typed
 * copy of `server/shared/toolDefinitions.js`. Hand-maintained copies drift, and
 ...
 *
 * Usage:
 *   node server/scripts/generate-mcp-tools.mjs           # write the file
 *   node server/scripts/generate-mcp-tools.mjs --check   # verify it is current
 */
...
const OUT_PATH = join(
  REPO_ROOT, 'reality-flow-mcp', 'src', 'services', 'generatedToolDefinitions.ts',
);
 ...
 *
 * Source:    server/shared/toolDefinitions.js (canonical registry)
 * Generator: server/scripts/generate-mcp-tools.mjs
