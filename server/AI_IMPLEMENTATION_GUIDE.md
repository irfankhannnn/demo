...
#### 1. Normalizers (`server/normalizers/`)
...
#### 2. AI View Builders (`server/aiViewBuilders/`)
...
#### 4. Middleware (`server/aiDtoMiddleware.js`)
...
#### 5. Integration (`server/skillInvoker.js`)
...
2. Review the design docs in `ai-response-design/` directory
