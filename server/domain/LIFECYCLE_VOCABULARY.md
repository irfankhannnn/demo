...
- `server/domain/crmDomainModel.js` — constants + labels
- `server/services/transferOwnership.js` — sale path
- `server/services/listingService.js` — listing create/withdraw
- `server/crmDynamodbService.js` — `convertLead`
