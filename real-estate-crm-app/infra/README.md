...
naming convention as the backend services (`server/`,
`reality-flow-authentication/`) — see `cfn-templates-cicd/reality-flow-authentication`
...
`cfn-templates-cicd/real-estate-crm-app/deploy.sh <dev|prod>` — it delegates
