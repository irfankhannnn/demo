          ...
          <div className="flex justify-between items-center gap-2 sm:gap-4">
            <div className="flex items-center gap-2 sm:gap-4 min-w-0">
              ...
              <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 truncate">{sellersOnly ? 'Sellers' : 'Owners'}</h1>
                  <p className="text-xs sm:text-sm text-gray-500">{filteredOwners.length} total</p>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
              ...
              <button
                ...
                className="flex items-center gap-1 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl hover:from-blue-600 hover:to-indigo-700 transition-all shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40"
              >
                <Plus className="h-4 w-4 sm:h-5 sm:w-5" />
                <span className="hidden sm:inline font-medium text-sm sm:text-base">Add Owner</span>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6">
          <div className="bg-white/60 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/20 p-3 sm:p-4 shadow-xl shadow-gray-200/30 hover:shadow-2xl transition-all duration-300 group">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xl sm:text-2xl font-bold text-gray-900">{owners.length}</p>
          ...
          <div className="bg-white/60 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/20 p-3 sm:p-4 shadow-xl shadow-gray-200/30 hover:shadow-2xl transition-all duration-300 group">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xl sm:text-2xl font-bold text-emerald-600">{owners.filter(o => o.status === 'active').length}</p>
          ...
          <div className="bg-white/60 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-white/20 p-3 sm:p-4 shadow-xl shadow-gray-200/30 hover:shadow-2xl transition-all duration-300 group col-span-2 sm:col-span-1">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xl sm:text-2xl font-bold text-purple-600">{owners.filter(o => (o.propertyCount || 0) > 0).length}</p>
