...
### See also [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#see-also)

[Response Reference for Facebook Automation](https://manychat.github.io/dynamic_block_docs/)

# Response Reference for Instagram, WhatsApp, and Telegram Automation

## Response format [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#response-format)
...
## Sending text [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#sending-text)
...
## Sending images [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#sending-images)
...
## Sending video files [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#sending-video-files)
...
## Sending audio files [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#sending-audio-files)
...
## Sending files [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#sending-files)
...
## Sending gallery cards [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#sending-gallery-cards)
...
## Buttons [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#buttons)

You can use buttons with each type: `url`, `flow`, `node`. You can provide custom actions to be performed with the button. Actions for buttons must comply with the same format and restrictions as described in the [Actions format](https://manychat.github.io/dynamic_block_docs/channels/#actions-format) below.
...
### Url button [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#url-button)
...
### Go to node button\* [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#go-to-node-button)
...
### Go to Flow button [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#go-to-flow-button)
...
### Buy button [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#buy-button)
...
## Action add tag [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#action-add-tag)
...
## Action remove tag [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#action-remove-tag)
...
## Action set contact’s field value [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#action-set-contacts-field-value)
...
## Action unset contact’s field value [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#action-unset-contacts-field-value)
...
## Go to node quick reply\* [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#go-to-node-quick-reply)
...
## Go to Flow Quick Reply [Anchor](https://manychat.github.io/dynamic_block_docs/channels/\#go-to-flow-quick-reply)
