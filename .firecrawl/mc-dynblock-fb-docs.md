# [dynamic\_block\_docs](https://manychat.github.io/dynamic_block_docs/)

### See also [Anchor](https://manychat.github.io/dynamic_block_docs/\#see-also)

[Response Reference for Instagram, WhatsApp, and Telegram Automation](https://manychat.github.io/dynamic_block_docs/channels/)

# Response Reference for Facebook Automation

## Response format [Anchor](https://manychat.github.io/dynamic_block_docs/\#response-format)
...
## Sending text [Anchor](https://manychat.github.io/dynamic_block_docs/\#sending-text)
...
## Sending images [Anchor](https://manychat.github.io/dynamic_block_docs/\#sending-images)
...
## Sending video file [Anchor](https://manychat.github.io/dynamic_block_docs/\#sending-video-file)
...
## Sending audio file [Anchor](https://manychat.github.io/dynamic_block_docs/\#sending-audio-file)
...
## Sending files [Anchor](https://manychat.github.io/dynamic_block_docs/\#sending-files)
...
## Sending gallery cards [Anchor](https://manychat.github.io/dynamic_block_docs/\#sending-gallery-cards)
...
## Buttons [Anchor](https://manychat.github.io/dynamic_block_docs/\#buttons)

You can use buttons with each type: `call`, `url`, `flow`, `node`, `buy`. You can provide custom action to be performed with the button. Actions can only be attached to the `url`, `flow`, and `node` button types. Actions for buttons must comply with the same format and restrictions as described in the [Actions format](https://manychat.github.io/dynamic_block_docs/#actions-format) below. The `"actions"` property is optional.
...
### Call button [Anchor](https://manychat.github.io/dynamic_block_docs/\#call-button)
...
### Url button [Anchor](https://manychat.github.io/dynamic_block_docs/\#url-button)
...
### Go to node button\* [Anchor](https://manychat.github.io/dynamic_block_docs/\#go-to-node-button)
...
### Go to Flow button [Anchor](https://manychat.github.io/dynamic_block_docs/\#go-to-flow-button)
...
### Buy button [Anchor](https://manychat.github.io/dynamic_block_docs/\#buy-button)
...
### Dynamic Block callback button [Anchor](https://manychat.github.io/dynamic_block_docs/\#dynamic-block-callback-button)
...
## Action add tag [Anchor](https://manychat.github.io/dynamic_block_docs/\#action-add-tag)
...
## Action remove tag [Anchor](https://manychat.github.io/dynamic_block_docs/\#action-remove-tag)
...
## Action set contact’s field value [Anchor](https://manychat.github.io/dynamic_block_docs/\#action-set-contacts-field-value)
...
## Action unset contact’s field value [Anchor](https://manychat.github.io/dynamic_block_docs/\#action-unset-contacts-field-value)
...
## Go to node Quick Reply\* [Anchor](https://manychat.github.io/dynamic_block_docs/\#go-to-node-quick-reply)
...
## Go to Flow Quick Reply [Anchor](https://manychat.github.io/dynamic_block_docs/\#go-to-flow-quick-reply)
...
## Dynamic Block callback Quick Reply [Anchor](https://manychat.github.io/dynamic_block_docs/\#dynamic-block-callback-quick-reply)
