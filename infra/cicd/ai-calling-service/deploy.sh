...
# services/ai-calling-service/infra/deploy.sh. This wrapper's only job is release
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../../services/ai-calling-service" && pwd)"
...
cmd_config_deploy() {
  ...
  echo "============================================="
  echo " AI Calling Service - config-only deploy -> $env"
  echo "============================================="
  echo "Branch:  $GIT_BRANCH ($GIT_COMMIT_SHORT, dirty=$GIT_DIRTY)"
  echo ""
