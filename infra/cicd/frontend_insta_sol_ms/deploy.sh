...
# apps/instagram/frontend_insta_sol_ms/infra/deploy.sh. This wrapper's only job is release
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../../apps/instagram/frontend_insta_sol_ms" && pwd)"
