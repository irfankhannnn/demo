...
# apps/property-pages-ms/infra/deploy.sh. This wrapper's only job is release
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../../apps/property-pages-ms" && pwd)"
...
# helper as apps/property-pages-ms/infra/deploy.sh, reused here for rollback-full,
