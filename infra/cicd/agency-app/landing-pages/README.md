...
```
agency-app/landing-pages/infra/deploy.sh
```
...
as `infra/cicd/agency-app/web` (see that folder's README for
...
`agency-app/landing-pages/infra/README.md` for what that changes in the CFN template
...
```
cd infra/cicd/agency-app/landing-pages
...
1. Resolves `ENV_FILE = agency-app/landing-pages/.env.<env>` — the argument selects
