...
#                                             agency-app/instagram-api/infra/
...
# agency-app/instagram-api/infra/deploy.sh. This wrapper's only job is release
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../../../agency-app/instagram-api" && pwd)"
...
# flow-authentication and infra/cicd/agency-app/api) ------------------------
next_config_version() {
