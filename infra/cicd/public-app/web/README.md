...
```
public-app/web/infra/deploy.sh
```
...
`infra/cicd/agency-app/web` (this file was adapted from it).
...
`public-app/web/infra/lib/env-guard.sh` against `.env.<env>`:
