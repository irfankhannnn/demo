...
# public-app/api/infra/deploy.sh. This wrapper's only job is release
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../../../public-app/api" && pwd)"
...
# helper as public-app/api/infra/deploy.sh, reused here for rollback-full,
...
verify_build_env() {
  ...
  # infra/cicd/agency-app/api and reality-flow-authentication.
