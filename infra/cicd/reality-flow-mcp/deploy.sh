...
#
# Usage: ./deploy.sh [OPTIONS] [dev|test|prod]   (run from infra/cicd/reality-flow-mcp/)
#
...
#   --config-only         Config-only deploy — ../../../services/reality-flow-mcp/infra/
...
# service's own script, which deploys services/reality-flow-mcp/infra/cfn-backend.yaml
# — the single source of truth — and writes services/reality-flow-mcp/infra/
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../../services/reality-flow-mcp" && pwd)"
