...
# script: services/marketplace-authentication/infra/deploy.sh (full) or
# services/marketplace-authentication/infra/config-deploy.sh (config-only). This
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../../services/marketplace-authentication" && pwd)"
