...
#                                             apps/instagram/backend_insta_sol_ms/infra/
...
# apps/instagram/backend_insta_sol_ms/infra/deploy.sh. This wrapper's only job is release
# bookkeeping, matching the design already used by
# infra/cicd/{server,reality-flow-authentication,real-estate-crm-app}.
#
...
SERVICE_DIR="$(cd "$SCRIPT_DIR/../../../apps/instagram/backend_insta_sol_ms" && pwd)"
...
# also global across dev/prod (same design as infra/cicd/reality-
# flow-authentication and infra/cicd/server) ------------------------
next_config_version() {
