...
- Original 22 skills were in `tools/claude-skills/skills/` but Cowork discovers skills from `.claude/skills/` or `.skills/skills/`
...
- Agent files like `brand-strategist.md` reference `tools/claude-skills/scripts/` with PowerShell paths
