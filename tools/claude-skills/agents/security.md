...
- CORS origin widened to `*` or to a non-owned domain (`agency-app/api/server.js` and the Lambda build config)
...
- Docker base image change in `platform/whatsapp-platform`
