...
**A) Remotion staticFile()** — Copy media to `marketing-and-sales/video-projects/my-video/public/` then reference with `staticFile("filename.mp4")`
```powershell
Copy-Item "media/my-videos/clip.mp4" "marketing-and-sales/video-projects/my-video/public/clip.mp4"
...
Copy-Item media/my-photos/*.jpg marketing-and-sales/video-projects/my-video/public/
...
Copy-Item media/my-screenshots/*.png marketing-and-sales/video-projects/my-video/public/
.\claude-skills\scripts\render-remotion.ps1 -Composition "DynamicComp" `
...
Copy-Item media/my-photos/*.jpg marketing-and-sales/video-projects/my-video/public/
Copy-Item media/my-videos/*.mp4 marketing-and-sales/video-projects/my-video/public/
Copy-Item media/my-audio/*.mp3 marketing-and-sales/video-projects/my-video/public/
...
```
```powershell
Copy-Item "media/my-audio/voiceover.mp3" "marketing-and-sales/video-projects/my-video/public/voiceover.mp3"
.\claude-skills\scripts\render-remotion.ps1 -Composition "DynamicComp" `
