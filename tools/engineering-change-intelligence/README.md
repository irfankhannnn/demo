...
```bash
cp tools/engineering-change-intelligence/.env.example tools/engineering-change-intelligence/.env
...
# Branch vs main
bash tools/engineering-change-intelligence/scripts/analyze-pr.sh --branch feat/auth

# Single commit
bash tools/engineering-change-intelligence/scripts/analyze-pr.sh --commit abc1234

# With Slack posting
bash tools/engineering-change-intelligence/scripts/analyze-pr.sh --pr 42 --slack
```
...
| Agent | File | Trigger |
|-------|------|---------|
| PR Orchestrator | `tools/claude-skills/agents/pr-orchestrator.md` | User invocation |
| PR Intelligence | `tools/claude-skills/agents/pr-intelligence.md` | Always |
| Architecture | `tools/claude-skills/agents/architecture.md` | IaC files |
| Kubernetes & Helm | `tools/claude-skills/agents/kubernetes-helm.md` | K8s manifests |
| CI/CD | `tools/claude-skills/agents/cicd.md` | Pipeline files |
| Security | `tools/claude-skills/agents/security.md` | Always |
| SRE & Observability | `tools/claude-skills/agents/sre-observability.md` | Always |
| FinOps | `tools/claude-skills/agents/finops.md` | Infra/cost files |
| Database | `tools/claude-skills/agents/database.md` | Migrations/SQL |
| Principal Engineer | `tools/claude-skills/agents/principal-engineer.md` | App code |
...
All reports save to `tools/engineering-change-intelligence/reports/`:
...
- Agent definitions: `tools/claude-skills/agents/pr-*.md`
- Skills: `tools/claude-skills/skills/*/SKILL.md`
- GitHub workflow: `.github/workflows/pr-intelligence.yml`
- Integrations: `tools/claude-skills/INTEGRATIONS.md` (Slack section)
