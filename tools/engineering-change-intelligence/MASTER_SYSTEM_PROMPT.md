...
5. Use `tools/engineering-change-intelligence/scripts/route-agents.sh` to determine which agents to invoke
...
Final output goes to Slack using the template at `tools/engineering-change-intelligence/templates/slack-message.md`.

Intermediate reports are saved to `tools/engineering-change-intelligence/reports/<pr-or-branch-name>/`.
