...
>
> **Not the product UI.** The CRM front-end uses blue `#2563EB` + Inter (`agency-app/web/tailwind.config.js`). That is deliberate and unrelated to the marketing brand. Screen recordings of the real product keep their own look — do not regrade the UI to marigold.
