...
- `real-estate-crm-app/src/components/PaywallModal.tsx` (modal pattern)
- `real-estate-crm-app/src/contexts/AuthContext.tsx`
- `server/routes/feedback.js` (or create if missing)
- `server/services/dynamodb.js` (NpsResponses table or create)

Build:

## Frontend
- Component: `real-estate-crm-app/src/components/NpsModal.tsx`
...
## Backend
- Route: `server/routes/feedback.js` POST /api/feedback/nps
