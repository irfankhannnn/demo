...
2. `agency-app/api/routes/auth.js` — find the registration/signup handler
3. `agency-app/web/src/pages/PhoneLogin.tsx` — the signup entry point
4. `agency-app/web/src/App.tsx` — understand where RegisterAdmin sits in the flow
5. `agency-app/web/src/pages/RegisterAdmin.tsx` — the final registration completion page

---

## What to Build

### 1. Update `agency-app/api/routes/auth.js` — registration handler
...
### 2. Update `agency-app/web/src/pages/PhoneLogin.tsx`
...
### 3. Update `agency-app/web/src/pages/RegisterAdmin.tsx`
...
- Any other handler in `agency-app/api/routes/auth.js` — only the registration success path
...
Files modified:
- agency-app/api/routes/auth.js — Brevo contact add + PostHog signup_completed in registration handler
- agency-app/web/src/pages/PhoneLogin.tsx — UTM capture on mount + signup_started event
- agency-app/web/src/pages/RegisterAdmin.tsx — UTM pass-through to API + sessionStorage cleanup
