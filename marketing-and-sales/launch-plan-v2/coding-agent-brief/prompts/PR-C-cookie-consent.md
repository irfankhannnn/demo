...
4. `real-estate-crm-app/src/App.tsx`
...
### 2. `real-estate-crm-app/src/components/CookieConsentBanner.tsx`
...
- `server/server.js` — no server changes needed
...
- real-estate-crm-app/src/components/CookieConsentBanner.tsx — CRM React banner (2 toggles, gates PostHog only)
- tests/cookie-consent.spec.ts — Playwright tests for both variants

Files modified:
- real-estate-crm-app/src/App.tsx — added CookieConsentBanner to LAUNCH LAYOUT COMPONENTS block
