...
| Features that do not exist: portal sync (MagicBricks/99acres/Housing), Facebook Messenger sync, Google Ads lead sync, a lead-leakage / ROI calculator, a "Broker Follow-up Tracker" lead magnet, Telegram | Verified absent. The calculator on `apps/landing-pages/agency-owners/index.html` is a placeholder. |
