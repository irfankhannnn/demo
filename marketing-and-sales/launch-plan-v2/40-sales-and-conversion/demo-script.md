...
**What to show:** the AI Employee pages in the CRM (`apps/crm/real-estate-crm-app/src/pages/crm/AiEmployee.tsx`), a WhatsApp thread where the AI Employee takes an inbound lead, qualifies it and writes it back.
