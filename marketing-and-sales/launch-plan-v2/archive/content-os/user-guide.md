...
The system is **spec-complete** but the product (`apps/crm/server/`, React app) does not yet measure anything. **Confirmed gap from the code: leads have no source / UTM / attribution / score today.** That is the P0 gate — until it ships, scoring, dashboards, and automations have no data.
