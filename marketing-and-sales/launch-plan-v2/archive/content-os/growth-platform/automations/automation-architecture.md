...
| AI call channel | `services/ai-calling-service/` (Exotel+ElevenLabs) | async trigger hook + outcome event |
...
| `aiCall.place` | `services/ai-calling-service/` (reuse, async) | Exotel+ElevenLabs | phone present + (intent OR consent) | no |
