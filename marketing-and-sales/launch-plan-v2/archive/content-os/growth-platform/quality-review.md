...
- Build is **spec-complete, not yet code** — `implementation/` is the buildable backlog; nothing shipped in `apps/crm/server/` yet (by design — this is the platform blueprint).
