...
> **Archived (17 Sep 2026):** June 2026 design record, kept for history. Not the current plan. Current source: no successor. Multi-business workspace scaffolding has no role in a single-brand playbook; restore this file if a second brand is ever onboarded.
...
5. **Re-cast characters.** Copy the 9 archetypes from `marketing-and-sales/launch-plan-v2/20-content-engine/cast-and-presenter.md` and re-skin names/looks/language for the new audience. Keep the *roles*.
...
All prompts in `marketing-and-sales/launch-plan-v2/20-content-engine/prompt-library.md` read `workspaces/{{ACTIVE_WORKSPACE}}/*`. Switching businesses = changing this one value.
