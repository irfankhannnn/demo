# 08 — CTA Library (RealEstateFlow Content OS)

> **500 Instagram CTAs** for RealEstateFlow (brand: RealtyFlow), the real estate CRM for Indian brokers. Hinglish (70/30), with Marathi-flavored lines for Pune. Voice: action-oriented, low-friction, street-smart.

**Handles & links:** IG `@realtyflow_india` · site `realtyflow.in` · demo `demo.realtyflow.in` · trial `app.realtyflow.in/signup`
**Pricing referenced:** Free / ₹999 / ₹2,999 / ₹5,999
...
- **language** — `hi-dominant` (Hindi-heavy), `mixed` (true 70/30 Hinglish, the default), `en-leaning` (English-heavy), `mr-dominant` (Marathi-flavored, Pune).
...
3. **Filter `ctas.json`** by `category` + `funnel_stage`, and by `language` if the piece is Pune-targeted (`mr-dominant`) or English-leaning.
...
| Drive sign-ups / conversions | BOFU | **TRIAL** | No-credit-card free trial = lowest-friction conversion. |
...
| CTA-DEMO-002 | 2 min ka demo, poora CRM samajh jaoge. demo.realtyflow.in | mixed | MOFU |
| CTA-DEMO-003 | Live demo book karo, hum dikhayenge sab kuch. | mixed | MOFU |
| CTA-DEMO-004 | Bina signup, demo dekho — demo.realtyflow.in pe jao. | mixed | TOFU |
...
| CTA-DEMO-028 | Real CRM, real demo — demo.realtyflow.in. | mixed | MOFU |
...
| CTA-DEMO-031 | Demo ke baad 90% log trial le lete hain. | mixed | BOFU |
...
| CTA-DEMO-034 | Guided demo book karo — ek RealtyFlow expert ke saath. | mixed | MOFU |
...
| CTA-DEMO-043 | Ek demo, saare doubts clear. demo.realtyflow.in. | mixed | MOFU |
...
| ID | CTA | Lang | Stage |
|---|---|---|---|
| CTA-TRIAL-001 | Free trial shuru karo — no credit card. app.realtyflow.in/signup | mixed | BOFU |
...
| CTA-TRIAL-012 | Trial lena hai? app.realtyflow.in/signup pe jao. | mixed | BOFU |
...
| CTA-TRIAL-025 | Free plan se shuru karo — 50 leads tak free. | mixed | BOFU |
...
| CTA-TRIAL-028 | Signup 2 min, value lifetime — trial lo. | mixed | BOFU |
...
| CTA-TRIAL-038 | Free trial — Pune ki agencies already chala rahi hain. | mr-dominant | BOFU |
...
| CTA-TRIAL-044 | Free trial — no expiry pressure, apne pace pe chalao. | mixed | BOFU |
...
| CTA-DM-038 | DM karo 'FREE' — free plan ka link bhej denge. | mixed | BOFU |
...
| CTA-COMMUNITY-005 | Join karo — 500+ agents already andar hain. | mixed | TOFU |
...
| CTA-LEAD-MAGNET-005 | Free guide: '30% leads kyun leak hote hain' — DM 'LEAK'. | mixed | MOFU |
...
| CTA-FOLLOW-002 | Real estate hacks chahiye? Follow @realtyflow_india. | mixed | TOFU |
...
| CTA-FOLLOW-005 | Follow @realtyflow_india for daily CRM gyaan. | mixed | TOFU |
...
| CTA-FOLLOW-011 | Agent banna serious hai? Follow @realtyflow_india. | mixed | TOFU |
...
| CTA-FOLLOW-016 | Follow @realtyflow_india — Hinglish mein gyaan. | mixed | TOFU |
...
| CTA-FOLLOW-024 | Follow @realtyflow_india — CRM, leads, growth. | mixed | TOFU |
...
| CTA-FOLLOW-029 | Follow @realtyflow_india aur tip-of-the-day pao. | mixed | TOFU |
...
| CTA-FOLLOW-036 | Mumbai/Pune/Delhi agents — follow @realtyflow_india. | mixed | TOFU |
...
| CTA-FOLLOW-040 | Real estate ka real content — follow @realtyflow_india. | mixed | TOFU |
...
| CTA-FOLLOW-046 | Follow @realtyflow_india before tum scroll karo. | mixed | TOFU |
