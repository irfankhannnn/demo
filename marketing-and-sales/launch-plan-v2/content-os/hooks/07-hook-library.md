# 07 — Hook Library (1,000 Hooks)

**1000 reusable Instagram hooks** for RealEstateFlow, each with a stable ID `HK-<CATEGORY>-NNN`. Hooks are the first 1–2 seconds of a reel — the scroll-stopper. Machine-readable copy in `hooks.json`.

> Voice: Hinglish 70/30 (+ Marathi for Pune), street-smart broker energy, ₹/lakh/crore. Each hook is tagged with a `language` (`hi-dominant` / `mixed` / `en-leaning` / `mr-dominant`) and `best_frameworks` (`FW-*`). The content factory (`production-sop/10-content-factory.md`) pulls a hook at **Step 4** whose category + framework + language match the piece.
...
3. Match the `language` tag to the language strategy for that city/persona/type.
...
- **Loss/number hook:** "100 leads aaye, 95 ka pata hi nahi."
- **Contrarian hook:** "Market down nahi, tumhari leakage problem hai."
- **Stop hook:** "Stop losing ₹50,000 to forgotten follow-ups."
...
| HK-FEAR-002 | Tumhare 30% leads silently mar rahe hain, aur tumhe pata bhi nahi. | mixed | FW-FEAR, FW-LEAD-LEAKAGE |
...
| HK-FEAR-008 | Stop losing ₹50,000 commissions to forgotten follow-ups. | en-leaning | FW-FEAR, FW-LEAD-LEAKAGE |
...
| HK-FEAR-057 | Stop trusting your memory with ₹10 lakh deals. | en-leaning | FW-FEAR, FW-CRM |
...
| HK-FEAR-066 | Tumhari pipeline ka 40% 'maybe' hai — aur maybe se EMI nahi bharti. | mixed | FW-FEAR, FW-LEAD-LEAKAGE |
...
| ID | Hook | Lang | Best Frameworks |
|---|---|---|---|
| HK-CURIOSITY-001 | Ye ek setting ne mere follow-up 3x kar diye — guess karo kaunsi. | mixed | FW-CURIOSITY, FW-DEMO |
...
| HK-CURIOSITY-006 | 90% agents isko galat kar rahe hain — tum bhi? | mixed | FW-CURIOSITY, FW-MISTAKE |
| HK-CURIOSITY-007 | Ek broker ne Excel chhoda, aur income 40% badh gayi. Connection? | mixed | FW-CURIOSITY, FW-BAB |
...
| HK-CURIOSITY-010 | Pune ki ek agency ne site visits double kar diye — bina extra staff. | mixed | FW-CURIOSITY, FW-CASE |
...
| HK-CURIOSITY-030 | Ye trick free hai, par 99% brokers use nahi karte. | mixed | FW-CURIOSITY, FW-MISTAKE |
...
| HK-CURIOSITY-039 | Iss broker ka follow-up rate 100% hai — bina diary, bina alarm. | mixed | FW-CURIOSITY, FW-FOLLOWUP |
...
| HK-CURIOSITY-048 | Ek reminder ne mujhe ₹2 lakh ki deal di. Sach mein. | hi-dominant | FW-CURIOSITY, FW-FOLLOWUP |
...
| HK-CURIOSITY-052 | Iss broker ne 0 ad budget se 30 deals kiye. Strategy andar. | mixed | FW-CURIOSITY, FW-CASE |
...
| HK-CURIOSITY-065 | Tumhe lagega ye chhoti baat hai — par yahi top 1% ko alag karta hai. | hi-dominant | FW-CURIOSITY, FW-AUTHORITY |
...
| HK-CURIOSITY-074 | Ek broker ne mujhe ye ek line boli aur mera business badal gaya. | hi-dominant | FW-CURIOSITY, FW-FOUNDER |
...
| HK-CURIOSITY-081 | Ek setting jo tumhari conversion 2x kar sakti hai — kisi ne batayi nahi. | mixed | FW-CURIOSITY, FW-CRM |
...
| ID | Hook | Lang | Best Frameworks |
|---|---|---|---|
| HK-REVENUE-001 | 100 leads se 5 deal aur 100 leads se 15 deal — fark sirf system ka hai. | mixed | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-002 | Ek miss follow-up = ek lakh ka nuksaan. Roz kitna chhod rahe ho? | mixed | FW-LEAD-LEAKAGE, FW-FEAR |
| HK-REVENUE-003 | Tumhari income leads pe nahi, follow-up pe depend karti hai. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-004 | Same leads, double income — sirf tracking badli. | mixed | FW-BAB, FW-REVENUE |
| HK-REVENUE-005 | ₹999 ka CRM ek ₹1 lakh ki deal bacha leta hai. Math karo. | mixed | FW-OBJECTION, FW-REVENUE |
| HK-REVENUE-006 | Tum ad pe ₹50,000 lagate ho, par leads waste kar dete ho. Ye loss hai. | mixed | FW-LEAD-LEAKAGE, FW-FEAR |
| HK-REVENUE-007 | Conversion 2% se 6% — yahi tumhari teen guni income hai. | mixed | FW-LEAD-LEAKAGE, FW-CASE |
| HK-REVENUE-008 | Har thanda lead jo dobara garam hua — extra commission hai. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-009 | Tumhe naye leads nahi chahiye — purane leads ka follow-up chahiye. | hi-dominant | FW-CONTRARIAN, FW-FOLLOWUP |
| HK-REVENUE-010 | Ek broker ne ₹0 extra spend kiya, par 40% zyada kamaaya. Kaise? System. | mixed | FW-CASE, FW-REVENUE |
| HK-REVENUE-011 | Tumhare paas paisa table pe pada hai — woh hai ignored leads. | mixed | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-012 | Mahine ka ek bada deal extra — bas yahi system ka ROI hai. | hi-dominant | FW-OBJECTION, FW-REVENUE |
| HK-REVENUE-013 | Commission leak roz hota hai — manual hisaab mein chhupa hota hai. | hi-dominant | FW-FEAR, FW-REVENUE |
| HK-REVENUE-014 | Income badhani hai? Pehle leakage band karo, fir ad chalao. | hi-dominant | FW-CONTRARIAN, FW-LEAD-LEAKAGE |
| HK-REVENUE-015 | Jis din tum har lead track karne lago, tumhari income jump karegi. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-016 | CRM kharcha nahi, ek silent salesman hai. | hi-dominant | FW-OBJECTION, FW-REVENUE |
| HK-REVENUE-017 | Tumhari sabse badi growth opportunity tumhare 'lost' leads mein hai. | mixed | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-018 | Ek extra deal = saal bhar ka CRM free. Soch lo. | hi-dominant | FW-OBJECTION, FW-REVENUE |
| HK-REVENUE-019 | Tum 12 ghante kaam karte ho, kamaate kam — kyunki leak ho raha hai. | hi-dominant | FW-LEAD-LEAKAGE, FW-FEAR |
| HK-REVENUE-020 | Pune ke ek broker ka revenue 6 mahine mein 2.5x — bas process tight kiya. | mixed | FW-CASE, FW-REVENUE |
| HK-REVENUE-021 | Naye lead pe ₹500 kharch, purane lead pe ₹0 — par dono mein deal chhupi hai. | mixed | FW-LEAD-LEAKAGE, FW-FOLLOWUP |
| HK-REVENUE-022 | Tumhe lagta hai market slow hai — actually tumhara follow-up slow hai. | mixed | FW-CONTRARIAN, FW-REVENUE |
| HK-REVENUE-023 | Ek deal jo follow-up se bachi — woh CRM ka 1 saal cover karti hai. | hi-dominant | FW-OBJECTION, FW-REVENUE |
| HK-REVENUE-024 | Revenue ka raaz: jo lead aaye, woh band na ho. Bas. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-025 | Tumhari pipeline ki value calculate ki? Shayad tum amir ho aur pata nahi. | mixed | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-026 | Agent ko commission clearly do, woh double mehnat karega — income tumhari. | hi-dominant | FW-TEAM, FW-REVENUE |
| HK-REVENUE-027 | AI calling ne mere dead leads se ₹4 lakh nikaal liye. | mixed | FW-AI, FW-REVENUE |
| HK-REVENUE-028 | Income tab badhti hai jab har lead ka ek next step ho. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-029 | Tumhare best season ke leads abhi bhi paisa de sakte hain — agar zinda hain. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-030 | Brokers jo system use karte hain, woh 30-50% zyada close karte hain. | mixed | FW-AUTHORITY, FW-REVENUE |
| HK-REVENUE-031 | Ek ₹999 ka tool tumhe ₹999 ka nahi — ₹5 lakh ka return de sakta hai. | mixed | FW-OBJECTION, FW-REVENUE |
| HK-REVENUE-032 | Tumhari kamaai ka leak point follow-up hai, market nahi. | hi-dominant | FW-CONTRARIAN, FW-LEAD-LEAKAGE |
| HK-REVENUE-033 | Math simple hai: 10% kam leakage = 10% zyada income. | mixed | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-034 | Jis broker ne khata digital kiya, uska disputed paisa wapas mila. | hi-dominant | FW-REVENUE |
| HK-REVENUE-035 | Tumhare paas 3 saal ka data hai — usme crores ki dead deals hain. | mixed | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-036 | Revenue double karna hai? Naye leads se pehle purane utilize karo. | hi-dominant | FW-CONTRARIAN, FW-FOLLOWUP |
| HK-REVENUE-037 | Har site visit ke baad follow-up = visit ki ROI double. | mixed | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-038 | Tumhari team ka har miss follow-up tumhari jeb se nikalta hai. | hi-dominant | FW-TEAM, FW-LEAD-LEAKAGE |
| HK-REVENUE-039 | Ek organized broker ek unorganized se 3x kamaata hai. Fact. | mixed | FW-AUTHORITY, FW-REVENUE |
...
| HK-REVENUE-042 | Tumhare cold leads warm ho sakte hain — AI ko bolo. | mixed | FW-AI, FW-REVENUE |
| HK-REVENUE-043 | Profit chhupa hota hai un calls mein jo tum nahi karte. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-044 | Tumhe ad budget nahi, follow-up discipline chahiye. | hi-dominant | FW-CONTRARIAN, FW-REVENUE |
| HK-REVENUE-045 | Ek lead ki cost nikalo, fir dekho kitne tum bin baat phenk rahe ho. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-046 | Same effort, better system, double commission. Yahi formula hai. | mixed | FW-BAB, FW-REVENUE |
| HK-REVENUE-047 | Tumhari income ka ceiling tumhari memory hai. Memory hatao. | hi-dominant | FW-CRM, FW-REVENUE |
| HK-REVENUE-048 | Khata clear hua toh partner khush, partner khush toh business double. | hi-dominant | FW-REVENUE |
| HK-REVENUE-049 | Roz 2 deal slip hoti hain — mahine ka 60. Calculate karo loss. | hi-dominant | FW-LEAD-LEAKAGE, FW-FEAR |
| HK-REVENUE-050 | Tum jo ad pe lagate ho, uska adha leakage mein jaata hai. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-051 | Revenue jump tab hua jab humne 'jo aaya usko close karo' rule banaya. | hi-dominant | FW-CASE, FW-REVENUE |
| HK-REVENUE-052 | AI se 1 ghante mein 50 calls — usme se ek deal bhi profit hai. | mixed | FW-AI, FW-REVENUE |
| HK-REVENUE-053 | Tumhara sabse mehnga lead woh hai jo tum follow-up nahi karte. | mixed | FW-LEAD-LEAKAGE, FW-FEAR |
| HK-REVENUE-054 | Income ka shortcut nahi hai — par leak band karna shortcut jaisa lagta hai. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-055 | Ek broker ne CRM liya, 3 mahine mein paisa double — case andar. | mixed | FW-CASE, FW-REVENUE |
| HK-REVENUE-056 | Tumhari pipeline ko paise mein convert karna seekho. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-057 | Jab follow-up automatic ho, income predictable ho jaati hai. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-058 | Tumhe 100 naye leads se zyada, 100 purane leads ka follow-up chahiye. | hi-dominant | FW-CONTRARIAN, FW-FOLLOWUP |
| HK-REVENUE-059 | Commission dispute mein paisa nahi, rishte bhi jaate hain. | hi-dominant | FW-FEAR, FW-REVENUE |
| HK-REVENUE-060 | Tumhari kamaai uss agent pe atki hai jo follow-up bhool jaata hai. | hi-dominant | FW-TEAM, FW-REVENUE |
| HK-REVENUE-061 | Ek system, teen guni deals — ye exaggeration nahi, math hai. | mixed | FW-BAB, FW-REVENUE |
| HK-REVENUE-062 | Lead leakage tumhari sabse badi 'invisible' expense hai. | mixed | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-063 | Tumhe pata bhi nahi tum amir broker ban sakte the — bas leak band karna tha. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-064 | Profit wahan hai jahan tumhari nazar nahi jaati — pipeline ke peeche. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-065 | CRM ka kharcha mahine ka, return saalon ka. | hi-dominant | FW-OBJECTION, FW-REVENUE |
| HK-REVENUE-066 | Aaj ke 5 follow-up = agle mahine ki 1 deal. Compound karo. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-067 | Tum sirf isliye gareeb broker ho kyunki tum disorganized broker ho. | hi-dominant | FW-CONTRARIAN, FW-REVENUE |
| HK-REVENUE-068 | Dead lead ek myth hai — sirf ignored lead hota hai. | mixed | FW-MYTH, FW-FOLLOWUP |
| HK-REVENUE-069 | Ek deal extra per mahina — yahi to wealth banata hai. | hi-dominant | FW-REVENUE, FW-FOLLOWUP |
| HK-REVENUE-070 | Tumhari mehnat sahi hai, system galat hai — isliye paisa nahi tikta. | hi-dominant | FW-CRM, FW-REVENUE |
| HK-REVENUE-071 | Jo broker numbers dekhta hai, woh numbers banata bhi hai. | mixed | FW-AUTHORITY, FW-REVENUE |
| HK-REVENUE-072 | Tumhe scaling se pehle 'plugging' chahiye — leak plug karo. | mixed | FW-LEAD-LEAKAGE, FW-CONTRARIAN |
| HK-REVENUE-073 | Ek lakh ka lead, ₹0 ka follow-up — phir bhi tum follow-up nahi karte. | hi-dominant | FW-FOLLOWUP, FW-FEAR |
| HK-REVENUE-074 | Income ka sabse bada lever: speed-to-lead. Tum kitne minute mein call karte ho? | mixed | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-075 | Tumhari diary mein crores dabe hain — sirf khud ko unlock karo. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-076 | Profit margin tumhare process ki cleanliness pe depend karta hai. | mixed | FW-CRM, FW-REVENUE |
| HK-REVENUE-077 | Tum jise 'slow month' bolte ho, woh 'poor follow-up month' hota hai. | mixed | FW-CONTRARIAN, FW-FOLLOWUP |
| HK-REVENUE-078 | Ek hi lead se 3 deal nikal sakti hain — agar relationship rakho. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-079 | Tumhe rich banne ke liye genius nahi, consistent follow-up chahiye. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REVENUE-080 | Saal ke ant mein hisaab karo — leakage hi tumhari biggest expense thi. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-REVENUE-081 | Ek extra deal per mahina = ek saal mein ek nayi gaadi. | hi-dominant | FW-REVENUE, FW-FOLLOWUP |
| HK-REVENUE-082 | Tumhari kamaai follow-up ki consistency ke barabar hai. | mixed | FW-REVENUE, FW-FOLLOWUP |
| HK-REVENUE-083 | Leak band karna naye leads laane se sasta hai. | mixed | FW-REVENUE, FW-LEAD-LEAKAGE |
...
| HK-SALES-003 | Jo broker pehle call karta hai, deal usi ki hoti hai. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-004 | 'Mahanga hai' bolne wala client actually 'samjha nahi' bol raha hai. | hi-dominant | FW-OBJECTION, FW-CONVO |
| HK-SALES-005 | Top closer aur average broker mein ek hi fark hai: consistency. | mixed | FW-AUTHORITY, FW-SALES |
| HK-SALES-006 | Client ko 5 min mein call karo — warna woh kisi aur ka ho jayega. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-007 | Sale tab hoti hai jab tum 7th time follow-up karte ho, 1st nahi. | mixed | FW-FOLLOWUP, FW-SALES |
| HK-SALES-008 | Closing ek event nahi — process hai. Process system se chalta hai. | mixed | FW-SALES, FW-CRM |
...
| HK-SALES-011 | Jo client call pe history yaad rakhe, woh deal jeet leta hai. | hi-dominant | FW-SALES, FW-PROPERTY |
| HK-SALES-012 | Pitch nahi, timing deal karwati hai. Timing system deta hai. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-013 | Sabse achha salesman? Woh jo kabhi follow-up nahi bhoolta. | hi-dominant | FW-FOLLOWUP, FW-SALES |
...
| HK-SALES-016 | Smart broker pitch kam, suntaa zyada hai — aur sab note karta hai. | mixed | FW-SALES, FW-CRM |
| HK-SALES-017 | Har 'main wapas call karunga' ek promise hai — usse mat todo. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-018 | Closing rate badhana hai? Speed-to-lead pe kaam karo. | mixed | FW-FOLLOWUP, FW-SALES |
| HK-SALES-019 | Client ko lagta hai tum bhool gaye — wahi pe deal marti hai. | hi-dominant | FW-FOLLOWUP, FW-FEAR |
| HK-SALES-020 | Sale ka 80% deal ke baad hota hai — follow-up mein. | mixed | FW-FOLLOWUP, FW-SALES |
...
| HK-SALES-023 | Pehla follow-up sabse aasaan hai — log 6th pe haar jaate hain. | mixed | FW-FOLLOWUP, FW-SALES |
| HK-SALES-024 | Client ka budget, family, urgency — sab yaad rakho, ya app ko bolo. | hi-dominant | FW-SALES, FW-CRM |
...
| HK-SALES-027 | Achha salesman lead nahi maangta — purane leads ko revive karta hai. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-028 | Client ko trust tab aata hai jab tum uski har baat yaad rakho. | hi-dominant | FW-SALES, FW-PROPERTY |
| HK-SALES-029 | Deal lose hone ka 1 reason: tum baad mein bhool gaye. | hi-dominant | FW-FOLLOWUP, FW-FEAR |
| HK-SALES-030 | Sale ek marathon hai, sprint nahi — system stamina deta hai. | mixed | FW-SALES, FW-CRM |
| HK-SALES-031 | Jab client confuse ho, structured info bhejo — deal khul jaati hai. | hi-dominant | FW-OBJECTION, FW-PROPERTY |
| HK-SALES-032 | Tum deal beech mein chhod dete ho — closers ant tak rehte hain. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-033 | Sabse mehnga client woh hai jise tum follow-up nahi karte. | mixed | FW-FOLLOWUP, FW-LEAD-LEAKAGE |
| HK-SALES-034 | Deal ka temperature track karo — hot, warm, cold. Phir attack karo. | mixed | FW-SALES, FW-CRM |
| HK-SALES-035 | Closing ka asli hero: reminder jo time pe baja. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-036 | Client ko impress karna hai? Uski purani baat yaad dilao. | hi-dominant | FW-SALES, FW-PROPERTY |
| HK-SALES-037 | Sale tab tak nahi hoti jab tak tum 'next step' set na karo. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-038 | Tum talented ho, organized nahi — isliye deal slip hoti hai. | hi-dominant | FW-CRM, FW-CONTRARIAN |
| HK-SALES-039 | Pune ka top broker pitch nahi, process se jeet ता hai. | mixed | FW-AUTHORITY, FW-SALES |
| HK-SALES-040 | Har deal ke peeche ek discipline hai jo dikhti nahi. | hi-dominant | FW-SALES, FW-AUTHORITY |
| HK-SALES-041 | Client ne dusre se liya kyunki woh 'available' tha, tum nahi. | hi-dominant | FW-FOLLOWUP, FW-FEAR |
| HK-SALES-042 | Deal close karna seekhna hai? Pehle follow-up close karna seekho. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-043 | Tumhari sale ki speed tumhari note-taking ki speed jitni hai. | mixed | FW-SALES, FW-CRM |
...
| HK-SALES-045 | Top broker 100 leads nahi chahta — 100% follow-up chahta hai. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-046 | Sale ka secret formula: yaad rakhna + time pe pahunchna. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-047 | Jo broker har lead ko 'serious' treat kare, woh hi serious paisa kamaata hai. | hi-dominant | FW-SALES, FW-LEAD-LEAKAGE |
| HK-SALES-048 | Client ki shaadi, kids, EMI — sab note rakho, deal personal ban jaati hai. | hi-dominant | FW-SALES, FW-CRM |
| HK-SALES-049 | Tum closing nahi seekh rahe — tum bhoolना band karo, sab theek ho jayega. | hi-dominant | FW-FOLLOWUP, FW-CONTRARIAN |
| HK-SALES-050 | Sale ko 'event' samajhna band karo — woh follow-up ka result hai. | mixed | FW-FOLLOWUP, FW-SALES |
| HK-SALES-051 | Client ko 3 din mein bhool jaate ho? Deal bhi 3 din mein bhool jayegi tumhe. | hi-dominant | FW-FOLLOWUP, FW-FEAR |
| HK-SALES-052 | Achhi sale ke peeche 8 follow-up hote hain. Tum 2 pe haar jaate ho. | mixed | FW-FOLLOWUP, FW-SALES |
| HK-SALES-053 | Client ka trust = consistency. Consistency = system. | mixed | FW-SALES, FW-CRM |
| HK-SALES-054 | Deal stuck hai? Shayad tumne next call set nahi kiya. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-055 | Sale ka sabse bada killer: 'main yaad rakhunga'. | hi-dominant | FW-FOLLOWUP, FW-MISTAKE |
| HK-SALES-056 | Tum better closer nahi, better follow-upper banoge toh deals badhengi. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-057 | Har deal ek timeline mangti hai — bina timeline deal random hai. | mixed | FW-SALES, FW-CRM |
| HK-SALES-058 | Closer woh hai jo client se zyada uski deal ko yaad rakhe. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-059 | Sale ka science: right lead, right time, right message. | mixed | FW-SALES, FW-AI |
| HK-SALES-060 | Tum sirf isliye haar rahe ho kyunki tum 'baad mein' bolte ho. | hi-dominant | FW-FOLLOWUP, FW-CONTRARIAN |
| HK-SALES-061 | Client jab ready hota hai, tum kahan hote ho? Reminder ke pास raho. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-062 | Deal jeetne wale broker note lete hain, baaki maafi maangte hain. | hi-dominant | FW-SALES, FW-CRM |
| HK-SALES-063 | Sale tab hoti hai jab system tumhe sahi din pe call karwaye. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-064 | Tum jise 'tough client' bolte ho, woh sirf 'slow follow-up client' hai. | mixed | FW-OBJECTION, FW-FOLLOWUP |
| HK-SALES-065 | Closing rate boost karne ka cheapest tarika: time pe wapas call karo. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-066 | Client ka har sawaal ek buying signal hai — note karo. | hi-dominant | FW-SALES, FW-CRM |
| HK-SALES-067 | Sale ek relationship hai, transaction nahi — relationships yaadon se chalti hain. | hi-dominant | FW-SALES, FW-CRM |
| HK-SALES-068 | Tumhari deal isliye nahi hui kyunki competitor 5 minute tez tha. | hi-dominant | FW-FOLLOWUP, FW-FEAR |
| HK-SALES-069 | Closing ka ustad woh hai jiske paas ek bhi lead 'forgotten' nahi. | hi-dominant | FW-FOLLOWUP, FW-SALES |
...
| HK-SALES-075 | Top broker ka raaz: koi lead bina next step ke nahi chhodta. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-076 | Deal band karne ke liye loud mat bano — punctual bano. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-077 | Tum jitna organized, utna confident — confidence sale karta hai. | hi-dominant | FW-CRM, FW-SALES |
| HK-SALES-078 | Client ko impress nahi, follow-up se trust jeeto. | hi-dominant | FW-FOLLOWUP, FW-SALES |
| HK-SALES-079 | Sale ka real MVP woh broker hai jiski memory machine pe hai. | hi-dominant | FW-CRM, FW-SALES |
| HK-SALES-080 | Jeetne wale deal pakadte hain, haarne wale 'busy' the. | hi-dominant | FW-FOLLOWUP, FW-CONTRARIAN |
| HK-SALES-081 | 'Sochta hoon' ka matlab 'follow-up karo' hota hai, 'chhod do' nahi. | hi-dominant | FW-SALES, FW-FOLLOWUP |
| HK-SALES-082 | Deal objection pe nahi, silence pe marti hai — follow-up karo. | mixed | FW-SALES, FW-FOLLOWUP |
| HK-SALES-083 | Closing ek event nahi, follow-ups ki chain ka result hai. | mixed | FW-SALES, FW-FOLLOWUP |
...
| HK-LEAD-MANAGEMENT-014 | Tumhare 70% leads ek baar call ke baad gayab ho jaate hain. | mixed | FW-LEAD-LEAKAGE, FW-FOLLOWUP |
...
| HK-LEAD-MANAGEMENT-021 | Tumhari pipeline ka 60% 'dead' label ke layak nahi — tum jaldbaaz the. | hi-dominant | FW-FOLLOWUP, FW-LEAD-LEAKAGE |
| HK-LEAD-MANAGEMENT-022 | Jab tak har lead trackable nahi, tab tak business gamble hai. | mixed | FW-CRM, FW-LEAD-LEAKAGE |
| HK-LEAD-MANAGEMENT-023 | Lead aate hi 5 min mein respond karo — yahi pe 80% deal banti hai. | mixed | FW-FOLLOWUP, FW-LEAD-LEAKAGE |
...
| HK-LEAD-MANAGEMENT-044 | Lead ki priority set karo — sab ko same time mat do. | hi-dominant | FW-CRM, FW-SALES |
...
| HK-LEAD-MANAGEMENT-074 | Sahi lead management se tum same leads se double deal nikaloge. | mixed | FW-CRM, FW-REVENUE |
...
| HK-LEAD-MANAGEMENT-078 | Har lead pe action lो ya use release karo — limbo sabse bura hai. | hi-dominant | FW-FOLLOWUP, FW-LEAD-LEAKAGE |
...
| HK-LEAD-MANAGEMENT-080 | Lead ko track karo jaise paisa — kyunki woh paisa hi hai. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
...
| HK-LEAD-MANAGEMENT-083 | Tum naye leads kharidte ho, purane leads ko marne dete ho. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
...
| HK-CRM-023 | CRM tumhe organize nahi karta — woh tumhe rich banata hai. | hi-dominant | FW-CRM, FW-REVENUE |
...
| HK-CRM-041 | CRM ki keemat ₹999, ek lost deal ki keemat ₹1 lakh. Decision aasaan hai. | mixed | FW-OBJECTION, FW-CRM |
...
| HK-CRM-051 | CRM = predictability. Predictability = peace + profit. | mixed | FW-CRM, FW-REVENUE |
...
| HK-CRM-055 | Tumhe CRM se zyada apni puraani aadaton se ladna padega — woh hi असली kaam hai. | hi-dominant | FW-CRM, FW-CONTRARIAN |
...
| HK-CRM-059 | CRM woh assistant hai jo na chhutti leta hai, na bhoolता hai. | hi-dominant | FW-CRM, FW-AI |
...
| HK-CRM-064 | CRM ka asli magic: har lead ko system kabhi bhoolता nahi. | hi-dominant | FW-CRM, FW-FOLLOWUP |
| HK-CRM-065 | Tumhare paas data hai — CRM usko paise mein badalta hai. | hi-dominant | FW-CRM, FW-REVENUE |
...
| HK-CRM-078 | CRM tumhe rich nahi banata — woh tumhe consistent banata hai, jo rich banata hai. | mixed | FW-CRM, FW-REVENUE |
...
| HK-AI-002 | Tum follow-up calls karte ho? Mera AI karta hai, main deals close karta hoon. | mixed | FW-AI, FW-REVENUE |
...
| HK-AI-005 | Tumhare dead leads zinda ho sakte hain — AI ko call karne do. | mixed | FW-AI, FW-REVENUE |
...
| HK-AI-011 | AI thakta nahi, bhoolता nahi, chutti nahi leta — best employee. | mixed | FW-AI, FW-TEAM |
...
| HK-AI-016 | AI calling ne meri team ka 10 ghanta/hafta bacha diya. | mixed | FW-AI, FW-REVENUE |
...
| HK-AI-030 | AI calling = scale without hiring. Bina staff, double output. | mixed | FW-AI, FW-REVENUE |
| HK-AI-031 | Tum ek time pe ek call karte ho, AI sau parallel. | mixed | FW-AI, FW-CURIOSITY |
| HK-AI-032 | AI ne meri purani database se 4 lakh nikaal liye. | mixed | FW-AI, FW-REVENUE |
...
| HK-AI-047 | AI ne meri reach 10x kar di bina ek extra rupee staff pe. | mixed | FW-AI, FW-REVENUE |
...
| HK-AI-050 | Tumhe naya banda hire karne se sasta — AI calling lagana. | mixed | FW-AI, FW-REVENUE |
...
| HK-AI-055 | AI calling se cold list bhi gold list ban sakti hai. | mixed | FW-AI, FW-REVENUE |
...
| HK-AI-065 | AI ne mere business ko ek aadmi se ek factory bana diya. | mixed | FW-AI, FW-REVENUE |
...
| HK-AI-072 | Pune ke ek broker ne AI lagaya, ab woh shaam ko ghar pe hota hai. | mixed | FW-AI, FW-CASE |
...
| HK-AI-082 | AI calling — scale without hiring, follow-up without forgetting. | mixed | FW-AI, FW-AGENCY-GROWTH |
...
| HK-REAL-ESTATE-003 | RERA ke baad, jo broker organized nahi, woh survive nahi karega. | mixed | FW-NEWS, FW-REAL-ESTATE |
| HK-REAL-ESTATE-004 | Mumbai mein deal close karna talent nahi — speed hai. | hi-dominant | FW-REAL-ESTATE, FW-FOLLOWUP |
...
| HK-REAL-ESTATE-006 | Real estate ek relationship business hai — relationships memory mangti hain. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-007 | Property bik jaati hai, par client zindagi bhar ka hota hai — usko track karo. | hi-dominant | FW-REAL-ESTATE, FW-FOLLOWUP |
| HK-REAL-ESTATE-008 | Real estate mein 90% broker side income samajh ke chhod dete hain. Galti. | hi-dominant | FW-CONTRARIAN, FW-REAL-ESTATE |
| HK-REAL-ESTATE-009 | Property dikhana aasaan hai — client ko yaad rakhna mushkil. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-010 | Mumbai-Pune ke broker ek hi galti karte hain: data phone mein rakhte hain. | hi-dominant | FW-REAL-ESTATE, FW-FEAR |
| HK-REAL-ESTATE-011 | Real estate ka game inventory ka nahi, information ka hai. | hi-dominant | FW-CONTRARIAN, FW-PROPERTY |
| HK-REAL-ESTATE-012 | Jo broker tezi se respond kare, woh hi premium client pakadta hai. | hi-dominant | FW-REAL-ESTATE, FW-FOLLOWUP |
| HK-REAL-ESTATE-013 | Property portals mahange ho gaye — par tumhara database free aur sona hai. | mixed | FW-REAL-ESTATE, FW-LEAD-LEAKAGE |
| HK-REAL-ESTATE-014 | Real estate mein consistency rare hai — isliye consistent broker rich hai. | mixed | FW-AUTHORITY, FW-REAL-ESTATE |
| HK-REAL-ESTATE-015 | Broker bhai, RERA number aur clean data — yahi tumhari credibility hai. | hi-dominant | FW-NEWS, FW-REAL-ESTATE |
| HK-REAL-ESTATE-016 | Property bik gayi, commission aaya — par usi client se 3 aur deal kahan? | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REAL-ESTATE-017 | Real estate ek long game hai — short memory wala haar jaata hai. | mixed | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-018 | Client ko property nahi, bharosa bechte ho — bharosa system se aata hai. | hi-dominant | FW-REAL-ESTATE, FW-SALES |
| HK-REAL-ESTATE-019 | Mumbai ka broker jo nahi badla, woh portal ki body shop ban gaya. | hi-dominant | FW-CONTRARIAN, FW-REAL-ESTATE |
| HK-REAL-ESTATE-020 | Real estate mein referral sabse sasta lead hai — par tum follow-up nahi karte. | mixed | FW-FOLLOWUP, FW-REAL-ESTATE |
...
| HK-REAL-ESTATE-023 | Broker ka kaam property bechना nahi — relationship maintain karna hai. | hi-dominant | FW-REAL-ESTATE, FW-FOLLOWUP |
| HK-REAL-ESTATE-024 | Mumbai market down ho ya up — organized broker dono mein kamaata hai. | hi-dominant | FW-CONTRARIAN, FW-REAL-ESTATE |
| HK-REAL-ESTATE-025 | Real estate mein tumhara naam tumhari recall hai — recall data se banta hai. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-026 | Property listing nahi, client need samajhna asli skill hai. | hi-dominant | FW-REAL-ESTATE, FW-PROPERTY |
| HK-REAL-ESTATE-027 | Pune mein deal speed pe hoti hai — jisne pehle inventory bheji, usne jeeta. | mixed | FW-REAL-ESTATE, FW-PROPERTY |
| HK-REAL-ESTATE-028 | Real estate broker ka 80% time follow-up me jaana chahiye, lead-hunt me nahi. | mixed | FW-FOLLOWUP, FW-CONTRARIAN |
| HK-REAL-ESTATE-029 | Builder badalta hai, project badalta hai — par tumhara client database stable hai. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-030 | Real estate mein tum jitna yaad rakho, utna kamaao. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-031 | Mumbai broker ka secret: har client ki shaadi-anniversary bhi yaad. | hi-dominant | FW-REAL-ESTATE, FW-SALES |
| HK-REAL-ESTATE-032 | Property bechना seekho mat — relationship banana seekho. Property to bik jayegi. | hi-dominant | FW-REAL-ESTATE, FW-SALES |
| HK-REAL-ESTATE-033 | Real estate ki sabsे badi capital? Tumhari past clients ki list. | hi-dominant | FW-REAL-ESTATE, FW-FOLLOWUP |
| HK-REAL-ESTATE-034 | Jo broker market ko blame karta hai, woh apne system ko chhupa raha hai. | hi-dominant | FW-CONTRARIAN, FW-REAL-ESTATE |
| HK-REAL-ESTATE-035 | RERA, GST, paperwork — sab track karna padta hai. Diary se nahi hoga. | mixed | FW-NEWS, FW-CRM |
| HK-REAL-ESTATE-036 | Real estate mein har 'NO' ek 'baad mein' hai — usko track karo. | hi-dominant | FW-FOLLOWUP, FW-REAL-ESTATE |
| HK-REAL-ESTATE-037 | Property dikhane ke baad ka follow-up — yahi pe asli broker bante hain. | hi-dominant | FW-FOLLOWUP, FW-REAL-ESTATE |
| HK-REAL-ESTATE-038 | Mumbai ka rent market chaotic hai — jiska system tight, uski deals fast. | mixed | FW-REAL-ESTATE, FW-PROPERTY |
| HK-REAL-ESTATE-039 | Real estate ek phone business ban gaya hai — toh phone ko CRM banao. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-040 | Broker ki value uske inventory mein nahi, uske network mein hai. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-041 | Real estate mein luck nahi, follow-up frequency deal karwati hai. | hi-dominant | FW-FOLLOWUP, FW-CONTRARIAN |
| HK-REAL-ESTATE-042 | Pune ke top broker portal pe kam, apne database pe zyada nirbhar hain. | mixed | FW-REAL-ESTATE, FW-AUTHORITY |
| HK-REAL-ESTATE-043 | Property bechने wala broker ordinary hai — relationship banane wala legend. | hi-dominant | FW-REAL-ESTATE, FW-AUTHORITY |
...
| HK-REAL-ESTATE-045 | Mumbai mein deal usko milti hai jiska response sabse tez hai. | hi-dominant | FW-REAL-ESTATE, FW-FOLLOWUP |
| HK-REAL-ESTATE-046 | Tumhara competitor RERA-compliant aur organized hai — tum? | mixed | FW-NEWS, FW-REAL-ESTATE |
| HK-REAL-ESTATE-047 | Real estate ka long-term khel: aaj ka tenant kal ka buyer hai. Track karo. | hi-dominant | FW-FOLLOWUP, FW-REAL-ESTATE |
| HK-REAL-ESTATE-048 | Property listing daily badalti hai — tumhari memory keep up nahi karegi. | hi-dominant | FW-PROPERTY, FW-CRM |
| HK-REAL-ESTATE-049 | Real estate broker ki asli net worth: uski organized client list. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-050 | Mumbai ho ya Pune — jeet uski jo client ko sabse jaldi wapas call kare. | hi-dominant | FW-REAL-ESTATE, FW-FOLLOWUP |
...
| HK-REAL-ESTATE-054 | Real estate game ka raaz: jo lead ko sabse zyada touch kare, woh jeete. | hi-dominant | FW-FOLLOWUP, FW-REAL-ESTATE |
| HK-REAL-ESTATE-055 | Mumbai property mehngi hai — toh ek bhi lost lead aur mehnga. | mixed | FW-REAL-ESTATE, FW-LEAD-LEAKAGE |
...
| HK-REAL-ESTATE-058 | Real estate mein tumhari sabse profitable property — purana client. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REAL-ESTATE-059 | Pune broker, ek baat yaad rakho: data tumhara dukaan hai, property nahi. | mr-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-060 | Real estate mein jo dikhta hai woh bikta hai — par jo yaad rehta hai woh jeetता hai. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-061 | Broker bante 100 hain, tikte 5 — fark? System aur follow-up. | hi-dominant | FW-CONTRARIAN, FW-CRM |
| HK-REAL-ESTATE-062 | Real estate ke har deal mein 3 aur deal chhupi hain — relationship rakho. | hi-dominant | FW-FOLLOWUP, FW-REVENUE |
| HK-REAL-ESTATE-063 | Mumbai market ka kadwa sach: speed-to-lead hi survival hai. | mixed | FW-REAL-ESTATE, FW-FOLLOWUP |
| HK-REAL-ESTATE-064 | Real estate mein tumhara mobile tumhara office hai — usko upgrade karo. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-065 | Property aaj hai kal nahi — par organized client list permanent hai. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-066 | Broker ka sabse bada competitor woh broker hai jo time pe call uthata hai. | hi-dominant | FW-REAL-ESTATE, FW-FOLLOWUP |
| HK-REAL-ESTATE-067 | Real estate mein har handshake ke baad ek follow-up due hota hai. | hi-dominant | FW-FOLLOWUP, FW-REAL-ESTATE |
| HK-REAL-ESTATE-068 | Mumbai mein deal milती usko jo 'available' rehta hai — system available rakhta hai. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-069 | Real estate ka asli skill: 6 mahine baad bhi client ka context yaad ho. | hi-dominant | FW-FOLLOWUP, FW-CRM |
| HK-REAL-ESTATE-070 | Property bechना art hai, par client manage karna science — science seekho. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-071 | Real estate mein tumhe agla unicorn nahi banna — bas organized banna hai. | mixed | FW-CRM, FW-CONTRARIAN |
| HK-REAL-ESTATE-072 | Mumbai ka har broker busy hai — par sirf organized waale profitable hain. | hi-dominant | FW-CONTRARIAN, FW-REVENUE |
| HK-REAL-ESTATE-073 | Real estate mein jeet ki recipe: fast response + zero forgotten leads. | mixed | FW-FOLLOWUP, FW-REAL-ESTATE |
| HK-REAL-ESTATE-074 | Builder relationship banao, par client database usse zyada sambhalo. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
...
| HK-REAL-ESTATE-076 | Property ka rate badalta hai — par disciplined broker ki growth nahi. | hi-dominant | FW-CONTRARIAN, FW-REAL-ESTATE |
| HK-REAL-ESTATE-077 | Real estate mein tum jitne approachable, utne deals — system available rakhta hai. | hi-dominant | FW-REAL-ESTATE, FW-CRM |
| HK-REAL-ESTATE-078 | Pune real estate mein marathi client trust deta hai jab tum yaad rakho. | mr-dominant | FW-REAL-ESTATE, FW-SALES |
| HK-REAL-ESTATE-079 | Real estate ka sach: 80% commission 20% organized broker kamaate hain. | mixed | FW-AUTHORITY, FW-REVENUE |
...
| HK-REAL-ESTATE-082 | Real estate mein fast reply hi sabse badi USP hai. | mixed | FW-REAL-ESTATE, FW-FOLLOWUP |
| HK-REAL-ESTATE-083 | Mumbai-Pune ka jeetne wala broker system se kaam karta hai. | mixed | FW-REAL-ESTATE, FW-CONTRARIAN |
| HK-REAL-ESTATE-084 | Buyer time pe response chahta hai, perfect ghar baad mein. | hi-dominant | FW-REAL-ESTATE, FW-FOLLOWUP |
...
| HK-AGENCY-GROWTH-002 | 5 agent rakhna aasaan hai — 5 agent ko track karna asli kaam hai. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-003 | Agency tab grow karti hai jab business tum pe nahi, system pe chale. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-004 | Tum naye agent hire kar rahe ho — par data dene ke liye system kahan? | hi-dominant | FW-TEAM, FW-CRM |
| HK-AGENCY-GROWTH-005 | Solo broker se agency banna — ek system ki doori hai. | hi-dominant | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-006 | Agency ki growth tumhare control mein hai — bas tum dekh nahi paa rahe. | hi-dominant | FW-AGENCY-GROWTH, FW-TEAM |
...
| HK-AGENCY-GROWTH-009 | Scaling ka matlab zyada chaos nahi — zyada system hai. | mixed | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-010 | Tumhari agency ka ceiling tumhari memory hai — usko hatao. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-011 | 10 agent, 10 alag tarike — yahi pe agency bikharti hai. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-012 | Agency growth = predictable process, na ki har mahine ka jugaad. | mixed | FW-CRM, FW-AGENCY-GROWTH |
...
| HK-AGENCY-GROWTH-014 | Agency badhane se pehle, leakage band karo — varna bada leak banega. | hi-dominant | FW-LEAD-LEAKAGE, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-015 | Tumhari agency ka asli problem manpower nahi, system hai. | hi-dominant | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-016 | Ek agency jo har lead track kare, woh kabhi shrink nahi hoti. | hi-dominant | FW-LEAD-LEAKAGE, FW-AGENCY-GROWTH |
...
| HK-AGENCY-GROWTH-020 | Tumhe 100 leads nahi chahiye — ek system chahiye jo 100 handle kare. | mixed | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-021 | Growth ka raaz: jo kaam tum karte ho, woh tumhare bina bhi ho. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-022 | Agency ka size matter nahi karta — uska system karta hai. | hi-dominant | FW-AGENCY-GROWTH, FW-AUTHORITY |
...
| HK-AGENCY-GROWTH-025 | Tumhari agency tab tak choti rahegi jab tak tum 'sab khud' karte raho. | hi-dominant | FW-CONTRARIAN, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-026 | Scaling ke liye paisa nahi, process chahiye — process system deता hai. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-027 | Agency owner ki neend system se aati hai, mehnat se nahi. | hi-dominant | FW-AGENCY-GROWTH, FW-BAB |
| HK-AGENCY-GROWTH-028 | Tum sirf isliye stuck ho kyunki sab kuch tumhare dimaag mein hai. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-029 | Growth chaos ko amplify karta hai — pehle order banao. | mixed | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-030 | Agency ko brand banane ke liye consistency chahiye — system deता hai. | hi-dominant | FW-AGENCY-GROWTH, FW-AUTHORITY |
| HK-AGENCY-GROWTH-031 | Tum 1 crore karte ho akele — system se 3 crore team se ho sakta hai. | mixed | FW-AGENCY-GROWTH, FW-REVENUE |
| HK-AGENCY-GROWTH-032 | Agency ki sehat ka thermometer: tumhari pipeline ki visibility. | mixed | FW-AGENCY-GROWTH, FW-LEAD-LEAKAGE |
| HK-AGENCY-GROWTH-033 | Tum agency badhate ho leads se — par leads sambhalta kaun? | hi-dominant | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-034 | Growth ek event nahi, ek system ka output hai. | mixed | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-035 | Tumhari agency tumhare bina ek din na chale? Toh tumne business nahi, job banayi. | hi-dominant | FW-CONTRARIAN, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-036 | Agency growth ka enemy: founder dependency. System usko todता hai. | mixed | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-037 | Tum chahe 2 ho ya 20 — bina system, sab ek doosre ke kaam mein takraaoge. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-038 | Agency ki growth tumhare data ki cleanliness pe atki hai. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-039 | Tum naye office kholte ho, par purane leads abhi tak leak ho rahe. | hi-dominant | FW-LEAD-LEAKAGE, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-040 | Agency owner banना hai? Pehle khud ko deal se replace karo, system se. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-041 | Growth tab predictable hai jab tum har number dekh sakte ho. | mixed | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-042 | Tumhari agency ke 3 agent rockstar hain, baaki dikhte nahi — system dikhayega. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-043 | Agency ki growth ka raaz: lead leak 0, follow-up rate 100%. | mixed | FW-LEAD-LEAKAGE, FW-FOLLOWUP |
| HK-AGENCY-GROWTH-044 | Tum agency ko badhana chahte ho par data alag-alag phones mein hai. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-045 | Scaling karna hai toh handover smooth hona chahiye — system se hota hai. | hi-dominant | FW-TEAM, FW-CRM |
| HK-AGENCY-GROWTH-046 | Agency ki sabse badi cost: invisible leakage. Pehle usko maaro. | mixed | FW-LEAD-LEAKAGE, FW-AGENCY-GROWTH |
...
| HK-AGENCY-GROWTH-048 | Agency tab tak nahi badhegi jab tak har agent accountable na ho. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-049 | Growth = tumhari best practice har agent tak pahunche, system se. | mixed | FW-TEAM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-050 | Tumhari agency ek aadmi ke phone pe khadi hai — ye risky model hai. | hi-dominant | FW-FEAR, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-051 | Agency owner, tumhari growth tumhari worst-tracked lead jitni hai. | mixed | FW-LEAD-LEAKAGE, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-052 | Bade banne ke liye, pehle organized bano — order pehle, scale baad. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
...
| HK-AGENCY-GROWTH-054 | Agency growth ka secret weapon: data jo decisions deta hai. | mixed | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-055 | Tum office bade karte ho, par system chhota hi rahta hai — wahi bottleneck. | hi-dominant | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-056 | Agency scale ke liye paisa second hai — process first hai. | mixed | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-057 | Tumhari agency ka future tumhare data ke safety pe tika hai. | hi-dominant | FW-FEAR, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-058 | Growth tumhe tab tak nahi milega jab tak tum repeat business na track karo. | hi-dominant | FW-FOLLOWUP, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-059 | Ek agency, ek dashboard, ek truth — yahi growth ki neev hai. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-060 | Tum chhote isliye nahi ho ki market chhota hai — tum disorganized ho. | hi-dominant | FW-CONTRARIAN, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-061 | Agency growth ka pehla KPI: kitne leads bina action ke pade hain. | mixed | FW-LEAD-LEAKAGE, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-062 | Tum agents add karte ho, par accountability add nahi karte — wahi galti. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-063 | Agency ki growth ek marathon hai — system stamina deta hai. | mixed | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-064 | Tum 'agar mere agent achhe hote' bolte ho — shayad system kharab hai. | hi-dominant | FW-TEAM, FW-CONTRARIAN |
| HK-AGENCY-GROWTH-065 | Agency double karni hai? Bina ek bhi naya lead, sirf process tight karo. | hi-dominant | FW-LEAD-LEAKAGE, FW-REVENUE |
| HK-AGENCY-GROWTH-066 | Tumhari agency growth ke liye taiyaar nahi — kyunki tumhara data ready nahi. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-067 | Growth ka matlab zyada deals nahi — zyada repeatable deals. | mixed | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-068 | Tum agency ko brand banaao — brand consistency se banta hai, system se. | hi-dominant | FW-AUTHORITY, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-069 | Agency owner ki sabse badi galti: sab khud sambhalne ki koshish. | hi-dominant | FW-CONTRARIAN, FW-TEAM |
| HK-AGENCY-GROWTH-070 | Tumhari growth ruk gayi? Tumhara system tumhari mehnat se chhota reh gaya. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-071 | Agency scale = tum chhutti pe jao, aur business chalti rahe. | hi-dominant | FW-AGENCY-GROWTH, FW-BAB |
| HK-AGENCY-GROWTH-072 | Tum jितना system pe invest karoge, utna agency tum pe nirbhar nahi rahegi. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-073 | Growth ki recipe: visible pipeline + accountable team + zero leakage. | mixed | FW-AGENCY-GROWTH, FW-TEAM |
| HK-AGENCY-GROWTH-074 | Tum aaj bhi 2 saal pehle wale tarike se chal rahe ho — wahi tumhara cap hai. | hi-dominant | FW-CONTRARIAN, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-075 | Agency tab badi hoti hai jab har choti cheez track hoti hai. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-076 | Tum growth chahte ho par chaos pal rahe ho — dono saath nahi chalte. | hi-dominant | FW-AGENCY-GROWTH, FW-CRM |
| HK-AGENCY-GROWTH-077 | Agency ki asli scale tab hoti hai jab knowledge agent ke saath na jaaye. | hi-dominant | FW-TEAM, FW-CRM |
| HK-AGENCY-GROWTH-078 | Tumhari agency ki growth story system se shuru hoti hai, hustle se nahi. | hi-dominant | FW-CRM, FW-AGENCY-GROWTH |
| HK-AGENCY-GROWTH-079 | Owner bhai, agency ki growth aapke control mein hai — bas system pakado. | hi-dominant | FW-AGENCY-GROWTH, FW-AUTHORITY |
| HK-AGENCY-GROWTH-080 | Agents nahi, system scale karta hai agency ko. | mixed | FW-AGENCY-GROWTH, FW-CONTRARIAN |
| HK-AGENCY-GROWTH-081 | Owner bottleneck ban gaya toh growth ruk gayi. | hi-dominant | FW-AGENCY-GROWTH, FW-FOUNDER |
| HK-AGENCY-GROWTH-082 | Sabse sasti growth: kho chuke leads wapas laao. | hi-dominant | FW-AGENCY-GROWTH, FW-LEAD-LEAKAGE |
| HK-AGENCY-GROWTH-083 | Repeatable process ke bina har naya hire ek naya jua. | hi-dominant | FW-AGENCY-GROWTH, FW-TEAM |
...
| HK-WHATSAPP-CHAOS-070 | WhatsApp tumhe 24x7 busy rakhता hai — par productive nahi. | hi-dominant | FW-WHATSAPP-CHAOS, FW-CRM |
...
| HK-TEAM-MANAGEMENT-013 | Tumhari team busy dikhती hai — par output kitna hai? | hi-dominant | FW-TEAM, FW-CONTRARIAN |
...
| HK-TEAM-MANAGEMENT-029 | Tumhe team se zyada apne system pe nirbhar hona chahiye. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
...
| HK-TEAM-MANAGEMENT-043 | Tum team ko scale karte ho, par chaos ko bhi scale kar dete ho. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
...
| HK-TEAM-MANAGEMENT-047 | Team ke beech lead chori hoti hai — accountability bina ye chalता rehega. | hi-dominant | FW-TEAM, FW-LEAD-LEAKAGE |
| HK-TEAM-MANAGEMENT-048 | Tumhari team ka follow-up rate dekho — wahi tumhari income ka raaz hai. | hi-dominant | FW-TEAM, FW-REVENUE |
...
| HK-TEAM-MANAGEMENT-060 | Tum team ki visibility ke bina growth chahte ho — namumkin. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
...
| HK-TEAM-MANAGEMENT-064 | Tumhari team mein invisible leakage hai — har agent thoda thoda chhodता hai. | hi-dominant | FW-TEAM, FW-LEAD-LEAKAGE |
...
| HK-TEAM-MANAGEMENT-066 | Tum team ke saath grow karna chahte ho — pehle visibility set karo. | hi-dominant | FW-TEAM, FW-AGENCY-GROWTH |
...
| HK-TEAM-MANAGEMENT-072 | Tum manager banना chahte ho? Pehle apni team ko dekhna seekho — system se. | hi-dominant | FW-TEAM, FW-CRM |
...
| HK-TEAM-MANAGEMENT-084 | Fair lead rotation se sabse weak agent bhi grow karta hai. | mixed | FW-TEAM, FW-AGENCY-GROWTH |
...
| HK-PROPERTY-MANAGEMENT-034 | Inventory organized ho toh tum confident dikhte ho — client buy karta hai. | hi-dominant | FW-PROPERTY, FW-SALES |
...
| HK-PROPERTY-MANAGEMENT-039 | Tumhe pata hona chahiye kaun si property kis client ko dikhayी. | hi-dominant | FW-PROPERTY, FW-CRM |
...
| HK-PROPERTY-MANAGEMENT-042 | Inventory turant share = client impressed = deal fast. | hi-dominant | FW-PROPERTY, FW-SALES |
| HK-PROPERTY-MANAGEMENT-043 | Property management ka matlab sirf list nahi — match + share + track. | mixed | FW-PROPERTY, FW-CRM |
| HK-PROPERTY-MANAGEMENT-044 | Tum property dhoondhne mein jितna time lागते ho, deal उतनी thandi hoti hai. | hi-dominant | FW-PROPERTY, FW-FOLLOWUP |
...
| HK-PROPERTY-MANAGEMENT-057 | Client ko 5 options ek message mein — yahi professional broker karta hai. | hi-dominant | FW-PROPERTY, FW-SALES |
...
| HK-PROPERTY-MANAGEMENT-060 | Inventory organized = client ka trust = repeat business. | hi-dominant | FW-PROPERTY, FW-REVENUE |
...
| HK-PROPERTY-MANAGEMENT-062 | Property aur buyer ka perfect match — yahi pe commission banta hai. | hi-dominant | FW-PROPERTY, FW-REVENUE |
...
| HK-PROPERTY-MANAGEMENT-070 | Tum client ki requirement bhool jaate ho — system har detail rakhता hai. | hi-dominant | FW-PROPERTY, FW-CRM |
| HK-PROPERTY-MANAGEMENT-071 | Property management = deal ki speed. Slow inventory = lost deal. | mixed | FW-PROPERTY, FW-CONTRARIAN |
| HK-PROPERTY-MANAGEMENT-072 | Tum property bechने jaate ho bina ready data ke — wahi unprofessional dikhता hai. | hi-dominant | FW-PROPERTY, FW-SALES |
...
| HK-PROPERTY-MANAGEMENT-075 | Property ko organize karna boring lagta hai — par yahi deal jeetता hai. | hi-dominant | FW-PROPERTY, FW-CONTRARIAN |
