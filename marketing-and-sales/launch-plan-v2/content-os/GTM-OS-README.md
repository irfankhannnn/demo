...
| **Roadmap** | `roadmap-30-60-90.md` | Sequenced execution | 14 |
...
## Start here
New AI agent: read `README.md` (Content OS) → this file → the layer you need → execute via `production-sop/11-prompt-library.md`. Activate a business with `ACTIVE_WORKSPACE`.
