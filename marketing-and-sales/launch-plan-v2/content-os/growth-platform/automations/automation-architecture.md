...
| AI call channel | `ai-calling-service/` (Exotel+ElevenLabs) | async trigger hook + outcome event |
...
| `aiCall.place` | `ai-calling-service/` (reuse, async) | Exotel+ElevenLabs | phone present + (intent OR consent) | no |
...
- Superseded sketch: `../../automation-os/architecture.md` (keep as pointer)
