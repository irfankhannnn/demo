...
- **Attribution** appears in `automation-os/architecture.md`, `implementation/technical-design.md`, `growth-dashboard.md` → growth-platform `attribution/` becomes the **single source of truth**; older files link to it.
...
- **Roadmaps**: `roadmap-30-60-90.md` exists → extend to 180 in `implementation/roadmaps/`; keep one canonical.
