...
| Roadmap (roadmap-30-60-90.md) | `implementation/roadmaps/...-180.md` | extended; legacy remains as the GTM-OS view |
...
- Build is **spec-complete, not yet code** — `implementation/` is the buildable backlog; nothing shipped in `server/` yet (by design — this is the platform blueprint).
