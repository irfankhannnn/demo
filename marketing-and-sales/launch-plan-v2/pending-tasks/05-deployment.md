...
> - DEPLOY-01 tagged route-injection blocks — present + verified in `agency-app/api/server.js` and `agency-app/web/src/App.tsx`.
...
2. Seed once: `node agency-app/api/scripts/seed-demo-tenant.js --reset`.
...
**Steps**
1. Deploy the server bundle to Lambda in `ap-south-1` (`docs/agency-app/api/DEPLOYMENT-GUIDE.md`).
