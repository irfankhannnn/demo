...
5. **Add signup checkbox** — modify `agency-app/web/src/components/auth/SignupForm.tsx` (or wherever signup lives) to add unchecked "I agree to ToS and Privacy" checkbox, block submit until ticked, log consent timestamp to DynamoDB `Users.consentSignedAt`.
