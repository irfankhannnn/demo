...
>
> The June draft said "only approved template messages may initiate outside the 24-hour window". That is a **WhatsApp Cloud API** rule. Today the product's WhatsApp is a **self-hosted Baileys service, QR-linked, not a BSP** (`platform/whatsapp-platform/`), and which number talks to prospects is undecided. So:
>
