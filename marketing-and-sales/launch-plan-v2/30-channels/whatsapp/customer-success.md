...
Note for whoever sends this: AI call minutes are billed in credits, and a trial tenant has a monthly allowance by default (`apps/crm/server/creditConfig.js`).
