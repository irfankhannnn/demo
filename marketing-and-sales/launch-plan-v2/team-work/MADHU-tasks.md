...
- [ ] **MAD-005-T1** — Run the AI Prompt from `P8-logo-and-favicons.md` using `nano-banana-pro`
  - Generate: `agency-app/web/public/logo-light.svg` + `logo-dark.svg`
...
- [ ] **MAD-005-T3** — Save all assets:
  ...
  - CRM SPA assets: `agency-app/web/public/` (favicon, manifest — for `app.realestateflow.in` browser tab)
