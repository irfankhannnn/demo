...
### `agency-app/api/middleware/tenantContext.ts`
...
### `agency-app/api/services/leadService.ts`
...
### `agency-app/api/db/migrations/001_init.sql`
...
|---|---|---|
| **Schema** | `agency-app/api/db/schema.ts` | Drizzle ORM definitions |
| **Connection** | `agency-app/api/db/client.ts` | RDS Proxy pool + Drizzle instance |
| **Middleware** | `agency-app/api/middleware/tenantContext.ts` | Set `app.tenant_id` per request |
| **Services** | `agency-app/api/services/*.ts` | Lead, Contact, Property, etc. CRUD |
| **Migrations** | `agency-app/api/db/migrations/*.sql` | DDL + RLS policies (auto-generated) |
| **Validation** | `agency-app/api/scripts/validateParity.ts` | Dual-write verification |
