...
- Current SyncBot runtime docs: [`docs/current_design/`](../current_design/)  
- WhatsApp UX templates: [`docs/interaction-design/`](../interaction-design/)  
- Working session notes: [`docs/working-context/`](../working-context/)  
