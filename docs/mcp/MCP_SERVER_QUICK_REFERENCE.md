...
**Full list:** See `apps/crm/server/shared/toolDefinitions.js`
...
### Local Development
```bash
node apps/crm/server/mcp-server/localServer.js
```
...
- `docs/mcp/PHASE_3_COMPLETION_SUMMARY.md` — Phase 3 completion details
- `docs/mcp/MCP_REMAINING_PLAN.md` — Remaining phases (4-9)
- `apps/crm/server/mcp-server/httpServer.js` — Main server code
- `apps/crm/server/mcp-server/resources.js` — Resource handlers
- `apps/crm/server/mcp-server/prompts.js` — Prompt generators
