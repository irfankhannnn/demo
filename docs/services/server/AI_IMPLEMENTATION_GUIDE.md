...
#### 1. Normalizers (`apps/crm/server/normalizers/`)
...
#### 2. AI View Builders (`apps/crm/server/aiViewBuilders/`)
...
#### 3. Services (`apps/crm/server/services/`)
...
#### 4. Middleware (`apps/crm/server/aiDtoMiddleware.js`)
...
#### 5. Integration (`apps/crm/server/skillInvoker.js`)
