...
60 s). See `apps/crm/server/marketplaceIndexing.js` for how a listing becomes
...
Mounted in `apps/crm/server/server.js`; implemented in
`apps/crm/server/routes/marketplaceInternal.js`. Base URL for callers:
...
## 2. marketplace-api — `apps/marketplace/marketplace-api/`
...
## 3. marketplace-authentication — `services/marketplace-authentication/`
...
## 4. marketplace-web — `apps/marketplace/marketplace-web/`
