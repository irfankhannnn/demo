...
→ [`ai-response-design/`](../../ai-response-design/)
...
| Concern | File |
|---------|------|
| System prompt | `server/agents/prompts.js` |
| Tool definitions | `server/shared/toolDefinitions.js` |
| Agent loop | `server/agents/agentRuntime.js` |
| Response formatting | `server/agents/responseFormatter.js`, `server/agents/formatting/` |
| AI DTO middleware | `server/aiDtoMiddleware.js` |
| View builders | `server/aiViewBuilders/*.js` |
