...
|---|---|---|
| Local | `agency-app/instagram-api/.env.local` | `META_APP_ID`, `META_APP_SECRET` |
| dev stack | `agency-app/instagram-api/.env.dev` | same |
| prod stack | `agency-app/instagram-api/.env.prod` | same |
