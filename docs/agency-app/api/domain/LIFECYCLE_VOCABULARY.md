...
- `agency-app/api/domain/crmDomainModel.js` — constants + labels
- `agency-app/api/services/transferOwnership.js` — sale path
- `agency-app/api/services/listingService.js` — listing create/withdraw
- `agency-app/api/crmDynamodbService.js` — `convertLead`
