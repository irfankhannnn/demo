...
Contract: `docs/agency-app/followup-agent/CONTRACTS.md` sections 2.2, 5 and 7.
Design: `docs/agency-app/followup-agent/APPROVAL-PLAN.md` sections 3.5 and 3.6.

## 1. Phone masking

Code: `agency-app/api/middleware/phoneMasking.js` (tests: `phoneMasking.test.js`).
...
Code: `agency-app/api/routes/clickToCall.js` (tests: `clickToCall.test.js`).

### Flow

```
Browser                    CRM (agency-app/api/)                       ai-calling-service            Exotel
...
CRM (`agency-app/api/`), already used by `routes/aiCalling.js`:
...
### Mounting in `agency-app/api/server.js`
