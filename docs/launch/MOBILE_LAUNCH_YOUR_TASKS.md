...
> Your GST certificate is in `docs/company-assets/GST Certificate.pdf`.
...
📄 **Full steps: [`docs/security-key-rotation.md`](../security-key-rotation.md)**
...
- [ ] Run the runbook in [`docs/security-key-rotation.md`](../security-key-rotation.md)
