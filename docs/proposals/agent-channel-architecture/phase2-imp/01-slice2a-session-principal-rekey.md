...
### 1. `server/conversationStateService.js`
...
### 2. `server/utils/whatsapp.js` — new `buildWhatsAppPrincipal(phone)`
...
### 4. `server/agents/agentRuntime.js`
...
### 5. `server/scripts/clear-whatsapp-conversation.js` (ops utility)
