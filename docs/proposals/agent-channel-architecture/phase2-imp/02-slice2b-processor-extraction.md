...
### The split: two new exported functions in `apps/crm/server/agents/agentRuntime.js`, not one
...
### `apps/crm/server/scripts/whatsapp-message-processor.js` — what's left
