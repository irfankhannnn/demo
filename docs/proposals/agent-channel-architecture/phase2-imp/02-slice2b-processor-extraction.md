...
### The split: two new exported functions in `agency-app/api/agents/agentRuntime.js`, not one
...
### `agency-app/api/scripts/whatsapp-message-processor.js` — what's left
