...
- **The underlying `deleteLead`/`deleteContact`/etc. functions were not removed** — they remain available for a genuine admin-only hard-delete path via `agency-app/api/routes/crm.js`.
