...
async function main() {
  ...
  if (action === 'list') {
    lastRequestLog = { method: 'GET', url: `${BASE}/api/crm/owners/${ownerId}/notes` };
    ...
    lastRequestLog = { method: 'POST', url: `${BASE}/api/crm/owners/${ownerId}/notes`, body: { content } };
    ...
    lastRequestLog = { method: 'PUT', url: `${BASE}/api/crm/owners/${ownerId}/notes/${noteId}`, body: { content } };
    const updRes = await axios.put(`${BASE}/api/crm/owners/${ownerId}/notes/${noteId}`, { content }, { headers });
    ...
    lastRequestLog = { method: 'DELETE', url: `${BASE}/api/crm/owners/${ownerId}/notes/${noteId}` };
    const delRes = await axios.delete(`${BASE}/api/crm/owners/${ownerId}/notes/${noteId}`, { headers });
