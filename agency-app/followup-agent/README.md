...
Exotel, and the CRM (`agency-app/api/`) owns leads, meetings, notifications and tenant
settings.
...
Full contracts: [docs/CONTRACTS.md](../../docs/agency-app/followup-agent/CONTRACTS.md). Design and findings:
[docs/APPROVAL-PLAN.md](../../docs/agency-app/followup-agent/APPROVAL-PLAN.md). Deploy order and ElevenLabs
dashboard steps: [docs/RUNBOOK.md](../../docs/agency-app/followup-agent/RUNBOOK.md).
...
npm run deploy:dev         # via infra/cicd/agency-app/followup-agent/deploy.sh
```
