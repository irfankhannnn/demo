...
#   Deploys agency-app/api/infra/launch-tables-cfn.yaml — the DynamoDB tables shared
...
#
#   This is a separate script (not agency-app/api/infra/deploy.sh) and a separate
...
# wrapper (infra/cicd/agency-app/launch-tables/deploy.sh) reads this back to
