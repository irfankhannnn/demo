...
# Store (see agency-app/api/config/ssmBootstrap.js), not via CFN Environment.Variables
...
#   1. agency-app/api/infra/sync-ssm-params.sh (already exists, already idempotent —
