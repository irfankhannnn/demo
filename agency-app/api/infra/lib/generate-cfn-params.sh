...
${lambda_code_parameter_json}
  ...
  { "ParameterKey": "MarketplaceInternalApiKey", "ParameterValue": "${MARKETPLACE_INTERNAL_API_KEY:-}" },
  { "ParameterKey": "MarketplaceApiDomainName", "ParameterValue": "${MARKETPLACE_API_DOMAIN_NAME:-}" },
  { "ParameterKey": "MarketplaceApiBasePath", "ParameterValue": "${MARKETPLACE_API_BASE_PATH:-}" },
  { "ParameterKey": "MarketplaceCallerApiKey", "ParameterValue": "${MARKETPLACE_CALLER_API_KEY:-}" },
  { "ParameterKey": "MarketplaceCities", "ParameterValue": "${MARKETPLACE_CITIES:-Mumbai,Navi Mumbai,Thane,Pune,Bengaluru,Hyderabad,Chennai,Delhi,Gurugram,Noida,Kolkata,Ahmedabad,Dubai}" },
