...
if (!CRM_TABLE_NAME) {
  throw new Error('CRM_DYNAMODB_TABLE_NAME is not set. Please configure it in agency-app/api/.env');
}
...
export async function createProperty(tenantId, data) {
  ...
  const property = {
    ...
    // Read by agency-app/api/publicListingService.js — see the allowlist rule there.
 ...
 *
 * Handler for the `match_properties` tool — see agency-app/api/shared/toolDefinitions.js.
 */
