 ...
 * USAGE
 * -----
 *   node agency-app/api/scripts/seed-demo-tenant.js [--reset] [--tenant=DEMO_REALESTATEFLOW]
 *
...
// Load agency-app/api/.env (same pattern as crmDynamodbService.js)
...
if (!CRM_TABLE) {
  console.error(
    'ERROR: CRM_DYNAMODB_TABLE_NAME is not set. Configure it in agency-app/api/.env (or the Lambda env).',
  );
  process.exit(1);
}
