 ...
 *
 * Usage:
 *   node agency-app/api/scripts/repair-lead-conversion-data.js [--apply] [--tenant TENANT_ID]
 *
 * Without --apply, only writes a JSON report to agency-app/api/scripts/reports/.
 */
