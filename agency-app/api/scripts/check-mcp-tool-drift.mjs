 ...
 *
 * `platform/mcp/src/services/generatedToolDefinitions.ts` is now GENERATED
...
const MCP_TOOLS_PATH = path.resolve(__dirname, '../../../platform/mcp/src/services/generatedToolDefinitions.ts');
...
function main() {
  ...
  console.log(`canonical (agency-app/api/shared/toolDefinitions.js): ${canonical.size} tools`);
  console.log(`mcp copy  (platform/mcp/.../toolDefinitions.ts): ${mcp.size} tools`);
