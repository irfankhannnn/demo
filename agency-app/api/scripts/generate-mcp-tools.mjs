 ...
 *
 * `platform/mcp/src/services/toolDefinitions.ts` used to be a hand-typed
 * copy of `agency-app/api/shared/toolDefinitions.js`. Hand-maintained copies drift, and
 ...
 *
 * Usage:
 *   node agency-app/api/scripts/generate-mcp-tools.mjs           # write the file
 *   node agency-app/api/scripts/generate-mcp-tools.mjs --check   # verify it is current
 */
...
const OUT_PATH = join(
  REPO_ROOT, 'platform', 'mcp', 'src', 'services', 'generatedToolDefinitions.ts',
);
 ...
 *
 * Source:    agency-app/api/shared/toolDefinitions.js (canonical registry)
 * Generator: agency-app/api/scripts/generate-mcp-tools.mjs
