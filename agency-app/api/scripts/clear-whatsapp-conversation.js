 ...
 *
 * Usage:
 *   node agency-app/api/scripts/clear-whatsapp-conversation.js <tenantId> <phone> [--dry-run]
 *
 * Examples:
 *   Preview what will be deleted:
 *     node agency-app/api/scripts/clear-whatsapp-conversation.js acme-corporation-edc6e9feb8 918291537522 --dry-run
 *
 *   Actually delete (requires confirmation):
 *     node agency-app/api/scripts/clear-whatsapp-conversation.js acme-corporation-edc6e9feb8 918291537522
 */
...
async function main() {
  ...
  if (positionalArgs.length !== 2) {
    console.error('Usage: node agency-app/api/scripts/clear-whatsapp-conversation.js <tenantId> <phone> [--dry-run]');
    console.error('Example: node agency-app/api/scripts/clear-whatsapp-conversation.js acme-corporation-edc6e9feb8 918291537522');
