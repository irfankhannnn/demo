...
- **Used by:** Engineering Change Intelligence Platform (`engineering-change-intelligence/`)
- **Agent:** `pr-orchestrator` → `release-readiness`
- **Script:** `engineering-change-intelligence/scripts/post-to-slack.sh`
...
- **Used by:** `engineering-change-intelligence/scripts/gather-pr-context.sh --pr`
