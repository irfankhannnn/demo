...
1. Run: bash engineering-change-intelligence/scripts/analyze-pr.sh --pr 42 --slack
2. Read engineering-change-intelligence/MASTER_SYSTEM_PROMPT.md
...
1. Ensure agents are available — they're in `claude-skills/agents/`
...
- Reports save to `engineering-change-intelligence/reports/`
