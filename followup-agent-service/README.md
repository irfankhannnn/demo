...
Exotel, and the CRM (`server/`) owns leads, meetings, notifications and tenant
settings.
...
Full contracts: [docs/CONTRACTS.md](docs/CONTRACTS.md). Design and findings:
[docs/APPROVAL-PLAN.md](docs/APPROVAL-PLAN.md). Deploy order and ElevenLabs
dashboard steps: [docs/RUNBOOK.md](docs/RUNBOOK.md).
...
npm run deploy:dev         # via cfn-templates-cicd/followup-agent-service/deploy.sh
```
