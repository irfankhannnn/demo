...
│     - Grievances & feedback                                     │
│                                                                  │
│  3. AI CALLING SERVICE (ai-calling-service/)                    │
│     - Call orchestration                                        │
│     - Exotel integration (telephony)                            │
│     - ElevenLabs integration (AI voice)                         │
│     - Bedrock knowledge base                                    │
│                                                                  │
│  4. ONBOARDING SERVICE (onboarding-page/)                       │
│     - Agency registration flow                                  │
│     - Member onboarding                                         │
│                                                                  │
│  5. VIDEO SERVICE (my-video/)                                   │
...
#### Authentication Service (`reality-flow-authentication/`)
...
#### AI Calling Service (`ai-calling-service/`)
