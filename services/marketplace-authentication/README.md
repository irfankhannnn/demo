...
is a trimmed clone of `services/reality-flow-authentication` with the agency
...
The API contract lives in `docs/services/marketplace-api/API-CONTRACT.md`
...
- CloudFormation in `infra/cfn-backend.yaml`; deploy via
  `infra/cicd/marketplace-authentication/deploy.sh`
