...
export const CALL_PURPOSE = {
  ...
  // field. See CRM's apps/crm/server/utils/leadRubric.js for the shared rubric text.
  LEAD_QUALIFICATION: 'lead_qualification',
  // Follow-up agent purposes (see docs/services/followup-agent-service/CONTRACTS.md).
