 ...
 * (`apps/crm/server/shared/toolDefinitions.js`) into `./generatedToolDefinitions.ts` by
 * `apps/crm/server/scripts/generate-mcp-tools.mjs`, which runs on `prebuild`. This file
